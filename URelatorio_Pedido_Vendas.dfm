object FrmRelatorio_Pedido_Vendas: TFrmRelatorio_Pedido_Vendas
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Relat'#243'rio Pedido de Vendas'
  ClientHeight = 329
  ClientWidth = 316
  Color = clBtnFace
  ...
  object Fim: TQuickRep
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel3: TQRLabel
        ...
        Alignment = taCenter
        AlignToBand = True
        Caption = '*** RELAT'#211'RIO PEDIDO DE VENDAS ***'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
