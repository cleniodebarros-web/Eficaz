...
type
  TFrmCadastro_Produtos = class(TForm)
...
var
  FrmCadastro_Produtos: TFrmCadastro_Produtos;
  Operacao: String;
  ID: Integer;
...
Procedure TFrmCadastro_Produtos.Legenda_produtos;
var
...
Procedure TFrmCadastro_Produtos.Exibir_Detalhes;
Begin
  {if (LeIni(Arq_Ini, 'Sistema', 'Exibir Detalhe Produto') = 'True') And
    ...
    { FrmDetalhes_Produto.Show;
     FrmDetalhes_Produto.Label5.Caption := QTabela.FieldByName('COD_ORIGINAL').AsString;
     FrmDetalhes_Produto.Label6.Caption := QTabela.FieldByName('MARCA').AsString;
     FrmDetalhes_Produto.Label7.Caption := QTabela.FieldByName('MODELO_POSICAO').AsString;
     FrmDetalhes_Produto.Label8.Caption := QTabela.FieldByName('APLICACAO').AsString;
     Consulta.SetFocus;}
...
procedure TFrmCadastro_Produtos.AlfabetoClick(Sender: TObject);
begin
...
procedure TFrmCadastro_Produtos.APLICACAOMouseEnter(Sender: TObject);
begin
  APLICACAO.Hint := QTabela.FieldByName('APLICACAO').AsString;
end;

procedure TFrmCadastro_Produtos.AtualizarNCMProdutosSelecionados1Click(Sender: TObject);
var
InputString: String;
begin
...
procedure TFrmCadastro_Produtos.AtualizarNCMTodosdaTela1Click(Sender: TObject);
var
InputString: String;
begin
  InputString := InputBox('Atualizar NCM', 'NCM:', '');
...
procedure TFrmCadastro_Produtos.Botoes_Editing;
begin
...
procedure TFrmCadastro_Produtos.Botoes_Normal;
begin
...
procedure TFrmCadastro_Produtos.DetailSearch(Tabela: String);
begin
...
procedure TFrmCadastro_Produtos.Habilitar(Status: Boolean);
var
I: Integer;
Temp: TComponent;
begin
...
procedure TFrmCadastro_Produtos.Insert;
var
I: Integer;
Temp: TComponent;
Sql, Par: String;
...
procedure TFrmCadastro_Produtos.LOCALIZACAO_IDExit(Sender: TObject);
begin
  DetailSearch('Localização');
end;

procedure TFrmCadastro_Produtos.Edit;
var
I: Integer;
Temp: TComponent;
Sql: String;
...
procedure TFrmCadastro_Produtos.EMPRESA_IDExit(Sender: TObject);
begin
  DetailSearch('Empresa');
end;

procedure TFrmCadastro_Produtos.EMPRESA_IDKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
function TFrmCadastro_Produtos.Validacao: Boolean;
var
Cst_Valido: Boolean;
begin
  Result := False;
...
procedure TFrmCadastro_Produtos.ManutencaoShow(Sender: TObject);
begin
  Set_Campos(False);
  Botoes_Normal;
...
procedure TFrmCadastro_Produtos.MenuItem1Click(Sender: TObject);
var
F, MyFile: TextFile;
     ...
     if FrmEtiquetas_Novos.Modelo.Text = 'Gôndola Individual' then
      begin
        ...
        begin
          ...
          D1  := Copy(IQuery.FieldByName('DESCRICAO').AsString, 1, 20);
          D2  := Copy(IQuery.FieldByName('DESCRICAO').AsString, 21, 20);
          B1  := IQuery.FieldByName('COD_BARRA').AsString;
...
procedure TFrmCadastro_Produtos.PageControl2Enter(Sender: TObject);
begin
  if Unidade.CanFocus then
    UNIDADE.SetFocus;
end;

procedure TFrmCadastro_Produtos.PRECO_VAREJOExit(Sender: TObject);
begin
if Preco_prazo.Value = 0.010 then
   Preco_prazo.Value := Preco_varejo.Value;
end;

procedure TFrmCadastro_Produtos.ibqryQControladosBeforeDelete(DataSet: TDataSet);
begin
...
procedure TFrmCadastro_Produtos.ibqryQControladosBeforeEdit(DataSet: TDataSet);
begin
...
procedure TFrmCadastro_Produtos.ibqryQControladosBeforePost(DataSet: TDataSet);
begin
...
procedure TFrmCadastro_Produtos.ibqryQControladosNewRecord(DataSet: TDataSet);
begin
  DataSet['PRODUTO_ID'] := QTabela.FieldByName('PRODUTO_ID').AsInteger;
end;

procedure TFrmCadastro_Produtos.ibqryQFabricanteBeforeDelete(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('EXCLUSAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para exclusão', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmCadastro_Produtos.ibqryQFabricanteBeforeEdit(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('ALTERACAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para alteração', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmCadastro_Produtos.ibqryQFabricanteBeforePost(DataSet: TDataSet);
begin
...
procedure TFrmCadastro_Produtos.ibqryQFabricanteNewRecord(DataSet: TDataSet);
begin
  DataSet['PRODUTO_ID'] := QTabela.FieldByName('PRODUTO_ID').AsInteger;
end;

procedure TFrmCadastro_Produtos.ibqryQProducaoAfterDelete(DataSet: TDataSet);
var
...
procedure TFrmCadastro_Produtos.ibqryQProducaoAfterPost(DataSet: TDataSet);
var
Vr_Produto , Vr_Custo_Produto: Real;
...
procedure TFrmCadastro_Produtos.ibqryQProducaoBeforeDelete(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('EXCLUSAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para exclusão', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmCadastro_Produtos.ibqryQProducaoBeforeEdit(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('ALTERACAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para alteração', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmCadastro_Produtos.ibqryQProducaoBeforePost(DataSet: TDataSet);
begin
...
procedure TFrmCadastro_Produtos.ibqryQProducaoNewRecord(DataSet: TDataSet);
begin
  DataSet['PRODUTO_ID'] := QTabela.FieldByName('PRODUTO_ID').AsInteger;
end;

procedure TFrmCadastro_Produtos.ibqryQSerieBeforeDelete(DataSet: TDataSet);
begin
  IQuery.Sql.Clear;
...
procedure TFrmCadastro_Produtos.ibqryQSerieBeforeEdit(DataSet: TDataSet);
begin
  IQuery.Sql.Clear;
  IQuery.Sql.Add('SELECT * FROM TRANSITENS_SERIE');
  IQuery.Sql.Add('WHERE');
...
procedure TFrmCadastro_Produtos.ibqryQSerieBeforePost(DataSet: TDataSet);
begin
...
procedure TFrmCadastro_Produtos.ibqryQSerieNewRecord(DataSet: TDataSet);
begin
  DataSet['PRODUTO_ID'] := QTabela.FieldByName('PRODUTO_ID').AsInteger;
end;

procedure TFrmCadastro_Produtos.REFERENCIAExit(Sender: TObject);
begin
  if (Operacao = 'Inserindo') and (REFERENCIA.Text <> '') then
  begin
    IQuery.Sql.Clear;
...
procedure TFrmCadastro_Produtos.Set_Campos(Vazio: Boolean);
var
I: Integer;
Temp: TComponent;
begin
...
procedure TFrmCadastro_Produtos.btnCompClick(Sender: TObject);
begin
  try
...
procedure TFrmCadastro_Produtos.btnCst_Pis_EntrClick(Sender: TObject);
begin
  CST_PIS_ENTR.Text := GetConsulta_CST('CST_PIS', CST_PIS_ENTR.Text);
end;

procedure TFrmCadastro_Produtos.btnCst_Cofins_EntrClick(Sender: TObject);
begin
  CST_COFINS_ENTR.Text := GetConsulta_CST('CST_COFINS', CST_COFINS_ENTR.Text);
end;

procedure TFrmCadastro_Produtos.btnNat_RecClick(Sender: TObject);
begin
...
procedure TFrmCadastro_Produtos.btnNCMClick(Sender: TObject);
begin
...
procedure TFrmCadastro_Produtos.btnNextClick(Sender: TObject);
begin
  if not QTabela.Eof then
  begin
    QTabela.Next;
...
procedure TFrmCadastro_Produtos.SUBTIPO_IDExit(Sender: TObject);
begin
  DetailSearch('Subtipo');
end;

procedure TFrmCadastro_Produtos.TabSheet5Show(Sender: TObject);
begin
QFabricante.Close;
...
procedure TFrmCadastro_Produtos.TabSheet6Show(Sender: TObject);
begin
  QProducao.Close;
...
procedure TFrmCadastro_Produtos.TabSheet7Show(Sender: TObject);
begin
  QSerie.Close;
...
procedure TFrmCadastro_Produtos.TRIBUTO_IDExit(Sender: TObject);
begin
  DetailSearch('Tributo');
end;

procedure TFrmCadastro_Produtos.UNIDADEExit(Sender: TObject);
begin
DetailSearch('Unidade');
end;

procedure TFrmCadastro_Produtos.UNIDADE_VENDAExit(Sender: TObject);
begin
DetailSearch('Unidade Venda');
end;

procedure TFrmCadastro_Produtos.btnComeca_ComClick(Sender: TObject);
begin
  {if LeIni(Arq_Ini, 'Sistema', 'Produto Retido') = 'True' then
  Begin
    DBGrid1.Columns[10]. FieldName     := 'RETIDO';
...
procedure TFrmCadastro_Produtos.btnComposicaoClick(Sender: TObject);
begin
  IQuery.Sql.Clear;
...
procedure TFrmCadastro_Produtos.btnCst_CofinsClick(Sender: TObject);
begin
  CST_COFINS.Text := GetConsulta_CST('CST_COFINS', CST_COFINS.Text);
end;

procedure TFrmCadastro_Produtos.btnCst_PisClick(Sender: TObject);
begin
  CST_PIS.Text := GetConsulta_CST('CST_PIS', CST_PIS.Text);
end;

procedure TFrmCadastro_Produtos.btnDeleteClick(Sender: TObject);
begin
  if FrmData.QAcesso.FieldByName('EXCLUSAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para exclusão', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmCadastro_Produtos.btnDiscardClick(Sender: TObject);
begin
  Botoes_Normal;
  Set_Campos(False);
...
procedure TFrmCadastro_Produtos.btnEditClick(Sender: TObject);
var
...
procedure TFrmCadastro_Produtos.btnEmpresaClick(Sender: TObject);
begin
  try
...
procedure TFrmCadastro_Produtos.btnFamiliaClick(Sender: TObject);
begin
  try
...
procedure TFrmCadastro_Produtos.btnGeneroClick(Sender: TObject);
begin
  COD_GEN.Text := GetConsulta_CST('GENEROS', COD_GEN.Text);
end;

procedure TFrmCadastro_Produtos.btnGrupoClick(Sender: TObject);
begin
  try
...
procedure TFrmCadastro_Produtos.btnImprimeClick(Sender: TObject);
begin
...
procedure TFrmCadastro_Produtos.btnInsertClick(Sender: TObject);
begin
...
procedure TFrmCadastro_Produtos.BtnInventarioClick(Sender: TObject);
var
InputString:string;
Id_Trans: Integer;
Vl_Trans: Real;
...
procedure TFrmCadastro_Produtos.btnLocalizacaoClick(Sender: TObject);
begin
  try
...
procedure TFrmCadastro_Produtos.btnPesquisaClick(Sender: TObject);
var
Condicao: String;
begin
  {if LeIni(Arq_Ini, 'Sistema', 'Produto Retido') = 'True' then
...
procedure TFrmCadastro_Produtos.btnPriorClick(Sender: TObject);
begin
  if not QTabela.Bof then
  begin
    QTabela.Prior;
...
procedure TFrmCadastro_Produtos.btnRetornaClick(Sender: TObject);
begin
  Close;
end;

procedure TFrmCadastro_Produtos.btnSaveClick(Sender: TObject);
var
...
procedure TFrmCadastro_Produtos.btnSub_TipoClick(Sender: TObject);
begin
  try
...
procedure TFrmCadastro_Produtos.btnTributoClick(Sender: TObject);
begin
  try
...
procedure TFrmCadastro_Produtos.Btn_embcpClick(Sender: TObject);
begin
  UNIDADE.Text := GetConsulta_CST('EMBALAGEM', UNIDADE.Text);
end;

procedure TFrmCadastro_Produtos.Btn_embvdClick(Sender: TObject);
begin
  UNIDADE_VENDA.Text := GetConsulta_CST('EMBALAGEM', UNIDADE_VENDA.Text);
end;

procedure TFrmCadastro_Produtos.cad_simplesClick(Sender: TObject);
begin
if CAD_SIMPLES.Checked then
   Begin
   NCM.Enabled            := False;
...
procedure TFrmCadastro_Produtos.btnParcialClick(Sender: TObject);
var
...
procedure TFrmCadastro_Produtos.COD_BARRAExit(Sender: TObject);
begin
...
procedure TFrmCadastro_Produtos.COD_ORIGINALExit(Sender: TObject);
begin
  if (Operacao = 'Inserindo') and (COD_ORIGINAL.Text <> '') then
  begin
    IQuery.Sql.Clear;
...
procedure TFrmCadastro_Produtos.Comeca_ComEnter(Sender: TObject);
begin
  Comeca_Com.Text := '';
end;

procedure TFrmCadastro_Produtos.Comeca_ComKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    btnComeca_ComClick(Sender);
end;

procedure TFrmCadastro_Produtos.ConsultaShow(Sender: TObject);
begin
...
procedure TFrmCadastro_Produtos.CST_COFINSChange(Sender: TObject);
begin
  CST_PIS.Text := CST_COFINS.Text;
end;

procedure TFrmCadastro_Produtos.CST_COFINS_ENTRChange(Sender: TObject);
begin
  CST_PIS_ENTR.Text := CST_COFINS_ENTR.Text;
end;

procedure TFrmCadastro_Produtos.CST_PISChange(Sender: TObject);
begin
  CST_COFINS.Text := CST_PIS.Text;
end;

procedure TFrmCadastro_Produtos.CST_PIS_ENTRChange(Sender: TObject);
begin
  CST_COFINS_ENTR.Text := CST_PIS_ENTR.Text;
end;

procedure TFrmCadastro_Produtos.CTRL_SERIEChange(Sender: TObject);
begin
...
procedure TFrmCadastro_Produtos.DBGrid1CellClick(Column: TColumn);
begin
Legenda_produtos;
end;

procedure TFrmCadastro_Produtos.DBGrid1DblClick(Sender: TObject);
begin
  Manutencao.Show;
end;

procedure TFrmCadastro_Produtos.DBGrid1DrawColumnCell(Sender: TObject; const Rect: TRect;
  DataCol: Integer; Column: TColumn; State: TGridDrawState);
var
  OldBkMode: Integer;
begin
...
procedure TFrmCadastro_Produtos.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
InputString: String;
...
procedure TFrmCadastro_Produtos.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  Manutencao.Show;
...
procedure TFrmCadastro_Produtos.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
InputString: String;
Codigo_Valido: Boolean;
...
procedure TFrmCadastro_Produtos.DBGrid1TitleClick(Column: TColumn);
begin
  {if LeIni(Arq_Ini, 'Sistema', 'Produto Retido') = 'True' then
  Begin
    DBGrid1.Columns[10]. FieldName     := 'RETIDO';
...
procedure TFrmCadastro_Produtos.DESCRICAOExit(Sender: TObject);
begin
  if ((Operacao = 'Inserindo') or (Operacao = 'Alterando')) and (FANTASIA.Text = '') then
    FANTASIA.Text := Copy(DESCRICAO.Text, 1, 24);
end;

procedure TFrmCadastro_Produtos.DESCRICAOKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmCadastro_Produtos.FAMILIA_IDExit(Sender: TObject);
begin
  DetailSearch('Família');
end;

procedure TFrmCadastro_Produtos.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TFrmCadastro_Produtos.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
...
procedure TFrmCadastro_Produtos.FormCreate(Sender: TObject);
begin
...
procedure TFrmCadastro_Produtos.FormMouseEnter(Sender: TObject);
begin
//FrmPrincipal.Gadget.Width := 1;
end;

procedure TFrmCadastro_Produtos.FormShow(Sender: TObject);
begin
  DBGrid1.SetFocus;
end;

procedure TFrmCadastro_Produtos.Grid_FabricanteColExit(Sender: TObject);
begin
  ...
  begin
    ...
    begin
      ...
      if IQuery.IsEmpty then
      begin
        QFabricante.FieldByName('DESCRICAO').AsString := '';
...
procedure TFrmCadastro_Produtos.Grid_FabricanteKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmCadastro_Produtos.Grid_FabricanteKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
...
procedure TFrmCadastro_Produtos.Grid_LoteKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmCadastro_Produtos.Grid_LoteKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    Keybd_Event(VK_TAB, 0, 0, 0);
...
procedure TFrmCadastro_Produtos.Grid_ProducaoColExit(Sender: TObject);
begin
...
procedure TFrmCadastro_Produtos.Grid_ProducaoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmCadastro_Produtos.Grid_ProducaoKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    Keybd_Event(VK_TAB, 0, 0, 0);
...
procedure TFrmCadastro_Produtos.Grid_SerieKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
InputString: String;
begin
...
procedure TFrmCadastro_Produtos.Grid_SerieKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    Keybd_Event(VK_TAB, 0, 0, 0);
...
procedure TFrmCadastro_Produtos.GRUPO_IDExit(Sender: TObject);
begin
  DetailSearch('Grupo');
end;
