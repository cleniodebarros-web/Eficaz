object FrmAgrupar_Vendas_Nfce: TFrmAgrupar_Vendas_Nfce
  Left = 250
  Top = 108
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Agrupar Vendas Nota Fiscal Eletr'#244'nica ao  Consumidor - NFC-e'
  ClientHeight = 530
  ClientWidth = 737
  Color = clBtnFace
  ParentFont = True
  ...
  object Label6: TLabel
    ...
    Height = 13
    Cursor = crHandPoint
    Caption = 'Para Selecionar p/ N'#186' de Documento Clique Aqui'
  ...
  object Chk_CfopOrigem: TCheckBox
    Left = 406
    Top = 37
    Width = 280
    Height = 17
    Caption = 'Importar itens do s cupons com CFOP origem da venda'
    TabOrder = 7
  end
