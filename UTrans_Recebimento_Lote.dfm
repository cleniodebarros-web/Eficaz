object FrmTrans_Recebimento_Lote: TFrmTrans_Recebimento_Lote
  ...
  object Panel2: TPanel
    ...
    object Label7: TLabel
      ...
      Width = 186
      Height = 13
      Caption = 'Vr. Total + Desp. + Juros + Multa'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clNavy
      Font.Height = -11
      Font.Name = 'Tahoma'
  ...
  object StatusBar2: TStatusBar
    ...
    Panels = <
      item
        Text = '<F3> - Prorroga Prazo/Despesas/Excluir'
        Width = 225
      end
      item
        Text = '<F4> - Marcar Recebimento com Perda'
        Width = 220
      end
      item
        Text = '<F5> - Reativar Recebimento (Perda)'
        Width = 210
      end
      item
        Text = '<F6> - Agrupar/Desagrupar'
        Width = 170
      end
      item
        Text = '<F9> - Continua'
  ...
  object RDprint1: TRDprint
    ...
    OpcoesPreview.BotaoProcurar = Inativo
    OpcoesPreview.BotaoPDF = Inativo
  ...
  object QTabela: TFDQuery
    ...
    SQL.Strings = (
      ''
      'SELECT * FROM TRANSACOES WHERE CONDUTA = '#39'07'#39
      'AND DT_TRANS = :DT_TRANS AND CLIENTE_ID = :CLIENTE_ID'
      'order by transacao_id DESC LIMIT 1')
    Left = 8
    Top = 352
    ParamData = <
      item
