object FrmRel_Logs: TFrmRel_Logs
  Left = 0
  Top = 0
  ...
  object Tipo_Ordem: TComboBox
    ...
    Items.Strings = (
      ...
      'clientes'
      'fornecedores'
      'Transac'#227'o Compra'
      'Transa'#231#227'o Venda'
      'Devolu'#231#227'o Compra'
      'Devolu'#231#227'o Venda')
  end
  object HR_MAI: TMaskEdit
    Left = 307
    Top = 6
    Width = 55
    Height = 21
  ...
  object QRel: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT "Eficaz_Logs".log.*,Funcionarios.Nome  from "Eficaz_Logs"' +
        '.log'
      
        'INNER JOIN FUNCIONARIOS ON "Eficaz_Logs".log.funcionario_id = fu' +
        'ncionarios.funcionario_id '
      'where tabela = :tabela and '
      'dt_log between :dt_inicial and :dt_final')
    Left = 8
    Top = 82
    ParamData = <
      item
