object FrmCheques_Emitidos: TFrmCheques_Emitidos
  Left = 0
  Top = 0
  ...
  object Panel1: TPanel
    ...
    object btnCopia: TButton
      ...
      Width = 75
      Height = 25
      Caption = 'C'#243'pia de Ch.'
      TabOrder = 1
      OnClick = btnCopiaClick
    end
  end
  object Copia_Cheque: TQuickRep
    Left = 6
    Top = 700
    Width = 794
    Height = 1123
    ...
    PrintIfEmpty = True
    ReportTitle = 'C'#243'pia de Cheque'
    SnapToGrid = True
    Units = MM
    Zoom = 100
    ...
    object DetailBand1: TQRBand
      ...
      object QRLabel14: TQRLabel
        ...
        Alignment = taLeftJustify
        AlignToBand = False
        Caption = 'Ass. Diretor Administrativo'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
      ...
      object QRLabel15: TQRLabel
        ...
        Alignment = taLeftJustify
        AlignToBand = False
        Caption = 'Ass. Diretor Financeiro'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
  ...
  object Rel_Cheques: TQuickRep
    ...
    PrinterSettings.ColorOption = 0
    PrintIfEmpty = True
    ReportTitle = 'Emiss'#227'o Cheques'
    SnapToGrid = True
    Units = MM
    Zoom = 100
    PrevFormStyle = fsNormal
    ...
    object QRBand1: TQRBand
      ...
      object Vr_Extenso: TQRLabel
        ...
        AutoSize = False
        Caption = 
          'NOVECENTOS E NOVENTA E NOVE MIL REAIS E NOVENTA E NOVE CENTAVOS ' +
          'XXXXXXX'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
  ...
  object QLancamentos: TFDQuery
    AfterOpen = QLancamentosAfterOpen
    Connection = FrmData.DbF_Eficaz
    FetchOptions.AssignedValues = [evAutoFetchAll]
    FetchOptions.AutoFetchAll = afTruncate
    SQL.Strings = (
      'SELECT TRANSACAO_ID,DT_ENT_SAI,FORNECEDORES.NOME FORNECEDOR,'
      'VALOR'
      'FROM TRANSACOES'
      
        'INNER JOIN FORNECEDORES ON FORNECEDORES.FORNECEDOR_ID = TRANSACO' +
        'ES.FORNECEDOR_ID'
      'WHERE NUM_CHEQUE = :NUM_CHEQUE AND BANCO_ID =:BANCO_ID')
    Left = 200
    Top = 240
    ParamData = <
      item
  ...
  object DataLancamento: TDataSource
