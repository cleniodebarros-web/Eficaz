...
type
  TFrmControle_Export = class(TForm)
    Panel1: TPanel;
    btnRetorna: TBitBtn;
    Label1: TLabel;
...
var
  FrmControle_Export: TFrmControle_Export;
...
procedure TFrmControle_Export.Insert;
var
I: Integer;
Temp: TComponent;
Sql, Par: String;
...
procedure TFrmControle_Export.Edit;
var
I: Integer;
Temp: TComponent;
Sql: String;
...
procedure TFrmControle_Export.btnOkClick(Sender: TObject);
begin
  if N_DI.Text = '' then
  begin
...
procedure TFrmControle_Export.FormCreate(Sender: TObject);
begin
Altera := False;
...
Transacao_id.Value := Id_Trans;
  ...
  Begin
    ...
    Chave_Nfe.Text    := IQuery.FieldByName('CHAVE_NFE').AsString;
    Altera := True;
  End;
...
procedure TFrmControle_Export.Grid_ItensKeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key = #46 then
    Key := #44;
