object FrmPre_Venda: TFrmPre_Venda
  ...
  object Cod_Barras: TEdit
    ...
    MaxLength = 13
    TabOrder = 2
    OnExit = Cod_BarrasExit
    OnKeyDown = Cod_BarrasKeyDown
  end
  ...
  object Orcamento: TQuickRep
    ...
    PrintIfEmpty = True
    ReportTitle = 'Cart'#227'o de Consumo - Pr'#233'-Venda'
    SnapToGrid = True
    Units = MM
    Zoom = 100
    ...
    object QRBand1: TQRBand
      ...
      object QRLabel3: TQRLabel
        ...
        Alignment = taCenter
        AlignToBand = True
        Caption = '*** CART'#195'O DE CONSUMO - PR'#201'-VENDA ***'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
  ...
  object Vendedor: TCurrencyEdit
    ...
    TabOrder = 0
    ZeroEmpty = False
    OnChange = VendedorChange
    OnEnter = VendedorEnter
    OnExit = VendedorExit
