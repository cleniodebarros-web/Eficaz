object FrmExtrato_Receita_RDP: TFrmExtrato_Receita_RDP
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Extrato Receita/Despesa (Caixa/Bancos)'
  ClientHeight = 144
  ClientWidth = 325
  Color = clBtnFace
  ...
  object Fluxo: TQuickRep
    ...
    PrintIfEmpty = True
    ReportTitle = 'Extrato Receita/Despesa'
    SnapToGrid = True
    Units = MM
    Zoom = 100
