        ...
        begin
          ...
          begin
           ...
           Else
            ...
            VL_MERC       := QRel.FieldByName('VALOR_PRODUTOS').AsFloat + QRel.FieldByName('VR_FCP').AsFloat + QRel.FieldByName('VR_FCPST').AsFloat;
            ...
            (QRel.FieldByName('CONDUTA').AsString = '02') and ((QRel.FieldByName('DEPTO').AsString = '10') or (QRel.FieldByName('DEPTO').AsString = '07')) then
            Begin
            VL_MERC       := QRel.FieldByName('VALOR_PRODUTOS').AsFloat + QRel.FieldByName('VR_IPI').AsFloat + QRel.FieldByName('VR_ICMS_ST').AsFloat + QRel.FieldByName('VR_FCP').AsFloat + QRel.FieldByName('VR_FCPST').AsFloat;
            VL_IPI        := 0;
            VL_BC_ICMS_ST := 0;
            VL_ICMS_ST    := 0;
            End;
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                VL_ITEM          := QItens.FieldByName('VR_TOTAL').AsFloat + QItens.FieldByName('VR_FCPST').AsFloat - QItens.FieldByName('VALOR_ICMS_DESON').AsFloat; //QItens.FieldByName('VR_TOTAL').AsFloat + QItens.FieldByName('VR_FCP').AsFloat + QItens.FieldByName('VR_FCPST').AsFloat;
                ...
                Begin
                  IF  (((QRel.FieldByName('CONDUTA').AsString = '02') and (QRel.FieldByName('DEPTO').AsString = '10')) or ((QRel.FieldByName('CONDUTA').AsString = '02') and (QRel.FieldByName('DEPTO').AsString = '07'))) then
                  Begin
                    Vl_ITEM         := Vl_ITEM + QItens.FieldByName('VR_IPI').AsFloat;
                    VL_IPI          := 0;
                    VL_BC_ICMS_ST   := 0;
                    VL_ICMS_ST      := 0;
                    if QRel.FieldByName('VR_ICMS_ST').AsFloat <> 0 then
