...
uses
  ...
  FireDAC.Comp.DataSet, FireDAC.Comp.Client, QRCtrls, QuickRpt;
...
begin
  try
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Table7.Edit;
          Table7.FieldByName('CURVA').AsString := 'C';
          Table7.Post;
    ...
    begin
      ...
      QRel.Sql.Clear;
      QRel.Sql.Add('SELECT TRANSACOES.CLIENTE_ID, SUM(TRANSACOES.VALOR) VALOR, CLIENTES.NOME');
     ...
     // QRel.Sql.Add('AND (TRANSACOES.COND_PAGTO = :COND_PAGTO)');
      ...
      QRel.Sql.Add('GROUP BY TRANSACOES.CLIENTE_ID,CLIENTES.NOME');
    ...
    begin
      ...
      QRel.Sql.Clear;
      QRel.Sql.Add('SELECT TRANSITENS.PRODUTO_ID, PRODUTOS.DESCRICAO, SUM(TRANSITENS.VR_TOTAL) VR_TOTAL');
    ...
    begin
      ...
      QRel.Sql.Clear;
      QRel.Sql.Add('SELECT TRANSACOES.FORNECEDOR_ID, SUM(TRANSACOES.VALOR) VALOR, FORNECEDORES.NOME');
      QRel.Sql.Add('FROM TRANSACOES');
     ...
     // QRel.ParamByName('COND_PAGTO').AsString   := 'A PRAZO';
      ...
      QRel.Sql.Add('GROUP BY TRANSACOES.FORNECEDOR_ID,FORNECEDORES.NOME');
      QRel.Sql.Add('ORDER BY VALOR DESC');
    ...
    begin
      ...
      bEGIN
      QRDBText9.DataField  := 'CODIGO';
      QRDBText12.DataField := 'NOME';
      end;
      Relatorio.Prepare;
      Relatorio.Preview;
...
begin
  ...
  begin
    ...
    begin
      ...
      if Id_Opcao = 16 then
        Label5.Caption := 'Curva ABC - Itens X Valor Total';
    end;
  end;
...
if table7.FieldByName('CURVA').AsString = '' Then
QRDBText1.Caption:= 'C';
