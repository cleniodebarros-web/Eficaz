  ...
  try
    ...
    begin
      try
        ...
        QArq.SQL.Add('FECHAR_STREAMING = :FECHAR_STREAMING, VENDA_VEICULOS_NOVOS = :VENDA_VEICULOS_NOVOS, SERIE = :SERIE, MODELOPADRAO = :MODELOPADRAO, ALTERAR_PRECO_CUSTO = :ALTERAR_PRECO_CUSTO, HORA_CONSISTE = :HORA_CONSISTE,');
        QArq.SQL.Add('REMARCA_NOVO = :REMARCA_NOVO, ESTOQUE_NEGATIVO_ORC_INTERNO = :ESTOQUE_NEGATIVO_ORC_INTERNO, NAO_EXIBIR_F_NO_G = :NAO_EXIBIR_F_NO_G, LIBERA_VALOR_UNITARIO_OS = :LIBERA_VALOR_UNITARIO_OS,');
        QArq.SQL.Add('PRECO_ATACADO_LISTA_PRODUTOS = :PRECO_ATACADO_LISTA_PRODUTOS WHERE EMPRESA_ID = :EMPRESA_ID ');
