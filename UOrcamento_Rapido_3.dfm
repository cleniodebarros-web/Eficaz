object FrmOrcamento_Rapido_3: TFrmOrcamento_Rapido_3
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Or'#231'amento R'#225'pido'
  ClientHeight = 402
  ClientWidth = 684
  Color = clBtnFace
  ...
  object StatusBar1: TStatusBar
    ...
    Panels = <
      ...
      item
        Text = '<F12> - Alterar Cliente/ Forma Pagto.'
        Width = 200
      end>
  end
  object fracao: TCurrencyEdit
    Left = 142
    Top = 76
    Width = 118
    Height = 21
