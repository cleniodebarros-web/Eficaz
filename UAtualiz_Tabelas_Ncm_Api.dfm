object FrmAtualiz_Tabelas_Ncm_Api: TFrmAtualiz_Tabelas_Ncm_Api
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Atualizar Tabela de Ncm (IBPT)'
  ClientHeight = 462
  ClientWidth = 608
  Color = clBtnFace
  ...
  object URL: TEdit
    ...
    Height = 21
    TabOrder = 7
    Text = 'ftp://arilmaqmatriz.dns.info/Ibpt/TabelaIBPTaxMG14.2.a.csv'
    Visible = False
  end
  object edArquivo: TEdit
    ...
    ReadOnly = True
    TabOrder = 0
    Text = 'C:\Eficaz7\TabelaIBPTaxMG17.1.B.csv'
  end
  ...
  object TmpCadastro: TFDTable
    AfterOpen = TmpCadastroAfterOpen
    Constraints = <
      item
        FromDictionary = False
      end>
    Connection = FrmData.DbF_Eficaz
    UpdateOptions.UpdateTableName = 'ibtp'
    SchemaName = 'public'
    TableName = 'ibtp'
    Left = 72
    Top = 433
