object FrmProdutos: TFrmProdutos
    ...
    object Manutencao: TTabSheet
      ...
      object PageControl2: TPageControl
        ...
        object TabSheet12: TTabSheet
          Caption = 'Localiza'#231#227'o do estoque'
          ImageIndex = 10
  ...
  object StatusBar1: TStatusBar
    ...
    Panels = <
      ...
      item
        Text = '<F9> - Loc. C'#243'd. Barras Principal'
        Width = 170
      end
      item
        Text = '<F10> - Loc. C'#243'd. Fabric.'
        Width = 50
      end>
  end
  ...
  object Qlocalizacao_Estoque: TFDQuery
    ...
    FetchOptions.AutoFetchAll = afDisable
    SQL.Strings = (
      'SELECT DESCRICAO, SUM(QUANTIDADE) QUANTIDADE '
      'FROM LOCALIZACAO_ESTOQUE_PRODUTOS'
