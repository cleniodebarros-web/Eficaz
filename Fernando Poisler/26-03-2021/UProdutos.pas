...
uses
  ...
  FireDAC.Comp.DataSet,BPLBOCXLib_TLB,Math,ShellApi;
...
begin
  ...
  //GravarLogSistema(QTabela,'Insert','Produtos',StrToint(funcionario_id.Text));
...
begin
  ...
  If  (FrmPrincipal.Config.FieldByName('AUDITORIA').AsString = 'True') Then
  GravarLogSistema(QTabela,'Before','Produtos',StrToint(funcionario_id.Text));
  ...
  QTabela.Locate('PRODUTO_ID', ID, [loCaseInsensitive]);
   ...
   If  (FrmPrincipal.Config.FieldByName('AUDITORIA').AsString = 'True') Then
  GravarLogSistema(QTabela,'Post','Produtos',StrToint(funcionario_id.Text));
...
begin
TFloatField(QProducao.FieldByName('QUANTIDADE')).DisplayFormat  := '#,##0.00';
end;
...
begin
  ...
  begin
    ...
    If  (FrmPrincipal.Config.FieldByName('AUDITORIA').AsString = 'True') Then
    GravarLogSistema(QTabela,'Delete','Produtos',StrToint(funcionario_id.Text));
