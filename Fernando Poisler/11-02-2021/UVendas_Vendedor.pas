...
// 125, 327
 QRel.Sql.Clear;
  ...
  begin
    ...
    QRel.Sql.Add('SELECT FUNCIONARIOS.NOME, FINALIZADORAS.LEGENDA, Sum(VR_ACRESCIMO) VR_ACRESCIMO, Sum(VR_DESCONTO) VR_DESCONTO, SUM(TRANSACOES.VALOR) VALOR');
