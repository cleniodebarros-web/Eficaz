object FrmEtiquetas: TFrmEtiquetas
  ...
  object Tipo_Font: TCheckBox
    Left = 186
    Top = 139
    Width = 133
    Height = 17
    Caption = 'Caracteres Comprimidos'
    Checked = True
    State = cbChecked
    TabOrder = 9
    OnKeyDown = DtmenKeyDown
  end
  object Impr: TComboBox
    Left = 72
    Top = 5
    Width = 247
    Height = 21
