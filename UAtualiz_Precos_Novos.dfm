object FrmAtualiz_Precos_Novos: TFrmAtualiz_Precos_Novos
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Atualiza'#231#227'o de Pre'#231'os (Produtos Novos/Faturados)'
  ClientHeight = 443
  ClientWidth = 794
  Color = clBtnFace
