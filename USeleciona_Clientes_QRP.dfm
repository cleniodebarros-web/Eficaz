object FrmSeleciona_Clientes: TFrmSeleciona_Clientes
  ...
  object QRel: TIBQuery
    ...
    SQL.Strings = (
      'SELECT CLIENTES.* , AUTORIZADOS.NOME AUTORIZADOS'
      'FROM CLIENTES'
      
        'INNER JOIN AUTORIZADOS  ON AUTORIZADOS.CLIENTE_ID = CLIENTES.CLI' +
        'ENTE_ID')
    Left = 32
    Top = 251
  end
  object RDprint2: TRDprint
    ...
    Margens.Bottom = 10
    Autor = Deltress
    RegistroUsuario.NomeRegistro = 'EFICAZ AUTOMA'#199#195'OO E SISTEMAS LTDA'
    RegistroUsuario.SerieProduto = 'GROUP-1013/02002'
    RegistroUsuario.AutorizacaoKey = 'HE4F-XWDQ-8IYJ-A11C-IOFH'
