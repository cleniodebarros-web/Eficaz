object FrmCalc_Orcamento: TFrmCalc_Orcamento
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Calcula medidas para Or'#231'amento'
  ClientHeight = 222
  ClientWidth = 402
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object BtnQuadrado: TBitBtn
      ...
      Width = 99
      Height = 25
      Caption = 'Metro &Quadrado'
      TabOrder = 3
      OnClick = BtnQuadradoClick
    end
    object btnlinear: TBitBtn
      Left = 212
      Top = 91
      Width = 93
      Height = 25
      Caption = 'Metro &Linear'
      TabOrder = 4
      OnClick = btnlinearClick
    end
    object Vr_Calculo: TsCalcEdit
      Left = 87
      Top = 137
      Width = 86
      Height = 21
