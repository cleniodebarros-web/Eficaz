object FrmRel_Doacoes: TFrmRel_Doacoes
  Left = 0
  Top = 0
  ...
  object Rel_Vendas_Doacao: TQuickRep
    Left = 118
    Top = 280
    Width = 794
    Height = 1123
    ...
    object QRGroup2: TQRGroup
      ...
      object QRLabel9: TQRLabel
        ...
        Alignment = taLeftJustify
        AlignToBand = False
        Caption = 'Entidade Doa'#231#227'o:'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
  ...
  object QEntidade: TFDQuery
    Connection = FrmData.DbF_Eficaz
    FetchOptions.AssignedValues = [evAutoFetchAll]
    FetchOptions.AutoFetchAll = afTruncate
    SQL.Strings = (
      'SELECT * FROM ENTIDADES_DOACAO'
      'WHERE'
  ...
  object DataEntidade: TDataSource
    DataSet = QEntidade
    Left = 42
    Top = 166
  end
