object FrmAtualiz_Banco_Criptografia: TFrmAtualiz_Banco_Criptografia
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Atualizar Banco Criptografia'
  ClientHeight = 413
  ClientWidth = 646
  Color = clBtnFace
  ...
  object QProdutos: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT PRODUTO_ID,DESCRICAO,COD_BARRA,PRECO_VAREJO,TRIBUTO_ID,AL' +
        'IQUOTA_ICMS FROM PRODUTOS')
    Left = 32
    Top = 368
  end
