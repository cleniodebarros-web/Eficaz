object FrmExtrato_Cliente_Fornecedor: TFrmExtrato_Cliente_Fornecedor
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Extrato de Cliente/Fornecedor'
  ClientHeight = 151
  ClientWidth = 326
  Color = clBtnFace
  ...
  object Extrato: TQuickRep
    ...
    PrintIfEmpty = True
    ReportTitle = 'Extrato de Cliente/Fornecedor'
    SnapToGrid = True
    Units = MM
    Zoom = 100
  ...
  object DataForne_Cliente: TDataSource
    Left = 48
    Top = 110
  end
  object QForne_Cliente: TFDQuery
