...
procedure TFrmProdutos.Cria_Dados_Temporarios;
begin
...
Procedure TFrmProdutos.Legenda_produtos;
var
...
Procedure TFrmProdutos.Exibir_Detalhes;
Begin
...
procedure TFrmProdutos.AlfabetoClick(Sender: TObject);
begin
...
procedure TFrmProdutos.APLICACAOMouseEnter(Sender: TObject);
begin
  APLICACAO.Hint := QTabela.FieldByName('APLICACAO').AsString;
end;

procedure TFrmProdutos.AtualizarCESTProdutoSelecionado1Click(Sender: TObject);
var
InputString:String;
begin
...
procedure TFrmProdutos.AtualizarCESTProdutosSelecionados1Click(Sender: TObject);
var
InputString:String;
begin
...
procedure TFrmProdutos.AtualizarCESTTodosdaTela1Click(Sender: TObject);
var
InputString:String;
begin
  InputString := InputBox('Atualizar CEST', 'Código CEST:', '');
...
procedure TFrmProdutos.AtualizarFamliadosprodutos1Click(Sender: TObject);
var
InputString : String;
begin
...
procedure TFrmProdutos.AtualizarFamliaProdutosSelecionad1Click(Sender: TObject);
var
InputString : String;
begin
 InputString := InputBox('Atualizar Família', 'Família Código:', '');
...
procedure TFrmProdutos.AtualizarNCMProdutosSelecionados1Click(Sender: TObject);
var
InputString: String;
begin
...
procedure TFrmProdutos.AtualizarNCMTodosdaTela1Click(Sender: TObject);
var
InputString: String;
begin
  InputString := InputBox('Atualizar NCM', 'NCM:', '');
...
procedure TFrmProdutos.AtualizarTributaoProdutosSelecionados1Click(
  Sender: TObject);
var
InputString:String;
begin
...
procedure TFrmProdutos.AtualizarTributaoProdutosSelecionados2Click(
  Sender: TObject);
var
InputString:String;
begin
...
procedure TFrmProdutos.AtualizarTributaoTodosdaTela1Click(Sender: TObject);
var
InputString:String;
begin
 InputString := InputBox('Atualizar Localização', 'Localização:', '');
...
procedure TFrmProdutos.Botoes_Editing;
begin
...
procedure TFrmProdutos.Botoes_Normal;
begin
...
procedure TFrmProdutos.BtnCalcularCustoCompraClick(Sender: TObject);
begin
...
procedure TFrmProdutos.DetailSearch(Tabela: String);
begin
...
procedure TFrmProdutos.Habilitar(Status: Boolean);
var
I: Integer;
Temp: TComponent;
begin
...
procedure TFrmProdutos.LOCALIZACAO_IDExit(Sender: TObject);
begin
  DetailSearch('Localização');
end;

procedure TFrmProdutos.Edit;
var
I: Integer;
Temp: TComponent;
Sql,Sql_open: String;
...
procedure TFrmProdutos.EMPRESA_IDExit(Sender: TObject);
begin
  DetailSearch('Empresa');
end;

procedure TFrmProdutos.EMPRESA_IDKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
function TFrmProdutos.Validacao: Boolean;
var
Cst_Valido: Boolean;
begin
  Result := False;
...
procedure TFrmProdutos.ManutencaoShow(Sender: TObject);
begin
                ...
                begin
                 ...
                 if LeIni(Arq_Ini, 'Sistema', 'Path Impressora') <> '' then
                  ...
                  try
                    ...
                    WriteLn(F, 'N');
                    WriteLn(F, 'D11');
                    WriteLn(F, 'A45,12,0,1,1,2,N,"' + E1 + '"');
                    WriteLn(F, 'A45,40,0,1,1,2,N,"' + D1 + '"');

                    if FrmEtiquetas_Novos.Modelo.Text = '3 Colunas' then
                      WriteLn(F, 'B35,70,0,E30,2,9,62,B,"' + B1 + '"');

                    if FrmEtiquetas_Novos.Preco.Checked then
                      WriteLn(F, 'A35,12,1,2,2,1,N,"' + P1 + '"');

                    WriteLn(F, 'A335,12,0,1,1,2,N,"' + E1 + '"');
                    WriteLn(F, 'A335,40,0,1,1,2,N,"' + D2 + '"');

                    if FrmEtiquetas_Novos.Modelo.Text = '3 Colunas' then
                      WriteLn(F, 'B325,70,0,E30,2,9,62,B,"' + B2 + '"');

                    if FrmEtiquetas_Novos.Preco.Checked then
                      WriteLn(F, 'A325,12,1,2,2,1,N,"' + P2 + '"');

                    WriteLn(F, 'A615,12,0,1,1,2,N,"' + E1 + '"');
                    WriteLn(F, 'A615,40,0,1,1,2,N,"' + D3 + '"');

                    if FrmEtiquetas_Novos.Modelo.Text = '3 Colunas' then
                      WriteLn(F, 'B605,70,0,E30,2,9,62,B,"' + B3 + '"');

                    if FrmEtiquetas_Novos.Preco.Checked then
                      WriteLn(F, 'A605,12,1,2,2,1,N,"' + P3 + '"');
...
procedure TFrmProdutos.NAT_RECExit(Sender: TObject);
begin
...
procedure TFrmProdutos.NCMKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TFrmProdutos.PageControl2Enter(Sender: TObject);
begin
  if Unidade.CanFocus then
    UNIDADE.SetFocus;
end;

procedure TFrmProdutos.PISExit(Sender: TObject);
begin
...
procedure TFrmProdutos.PIS_ENTRExit(Sender: TObject);
begin
...
procedure TFrmProdutos.PRECO_VAREJOExit(Sender: TObject);
begin
if Preco_prazo.Value = 0.010 then
   Preco_prazo.Value := Preco_varejo.Value;
end;

procedure TFrmProdutos.QDesagregacaoAfterOpen(DataSet: TDataSet);
begin
...
procedure TFrmProdutos.QDesagregacaoBeforeDelete(DataSet: TDataSet);
begin
...
procedure TFrmProdutos.QDesagregacaoBeforeEdit(DataSet: TDataSet);
begin
...
procedure TFrmProdutos.QDesagregacaoBeforePost(DataSet: TDataSet);
begin
...
procedure TFrmProdutos.QDesagregacaoNewRecord(DataSet: TDataSet);
begin
DataSet['PRODUTO_ID'] := QTabela.FieldByName('PRODUTO_ID').AsInteger;

end;

procedure TFrmProdutos.QFabricanteBeforeDelete(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('EXCLUSAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para exclusão', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.QFabricanteBeforeEdit(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('ALT_PRODUTOS').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para alteração', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.QFabricanteBeforePost(DataSet: TDataSet);
begin
...
procedure TFrmProdutos.QFabricanteNewRecord(DataSet: TDataSet);
begin
  DataSet['PRODUTO_ID'] := QTabela.FieldByName('PRODUTO_ID').AsInteger;
end;

procedure TFrmProdutos.Qlocalizacao_EstoqueAfterOpen(DataSet: TDataSet);
begin
TFloatField(QLocalizacao_Estoque.FieldByName('QUANTIDADE')).DisplayFormat  := '#,##0.00';
end;

procedure TFrmProdutos.Qlocalizacao_EstoqueBeforeDelete(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('EXCLUSAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para exclusão', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.Qlocalizacao_EstoqueBeforeEdit(DataSet: TDataSet);
begin
 if FrmData.QAcesso.FieldByName('ALT_PRODUTOS').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para alteração', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.QloteAfterOpen(DataSet: TDataSet);
begin
...
procedure TFrmProdutos.QloteNewRecord(DataSet: TDataSet);
begin
 DataSet['PRODUTO_ID']    := QTabela.FieldByName('PRODUTO_ID').AsInteger;
end;

procedure TFrmProdutos.QProducaoAfterDelete(DataSet: TDataSet);
var
...
procedure TFrmProdutos.QProducaoAfterOpen(DataSet: TDataSet);
begin
TFloatField(QProducao.FieldByName('QUANTIDADE')).DisplayFormat  := '#,##0.0000';
end;

procedure TFrmProdutos.QProducaoAfterPost(DataSet: TDataSet);
var
Vr_Produto , Vr_Custo_Produto: Real;
...
procedure TFrmProdutos.QProducaoBeforeDelete(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('EXCLUSAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para exclusão', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.QProducaoBeforeEdit(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('ALT_PRODUTOS').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para alteração', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.QProducaoBeforePost(DataSet: TDataSet);
begin
...
procedure TFrmProdutos.QProducaoNewRecord(DataSet: TDataSet);
begin
 DataSet['PRODUTO_ID'] := QTabela.FieldByName('PRODUTO_ID').AsInteger;
end;

procedure TFrmProdutos.QSerieBeforeDelete(DataSet: TDataSet);
begin
  IQuery.Sql.Clear;
...
procedure TFrmProdutos.QSerieBeforeEdit(DataSet: TDataSet);
begin
  IQuery.Sql.Clear;
  IQuery.Sql.Add('SELECT * FROM TRANSITENS_SERIE');
  IQuery.Sql.Add('WHERE');
...
procedure TFrmProdutos.QSerieNewRecord(DataSet: TDataSet);
begin
DataSet['PRODUTO_ID'] := QTabela.FieldByName('PRODUTO_ID').AsInteger;
end;

procedure TFrmProdutos.QSimilarBeforeDelete(DataSet: TDataSet);
begin
 if FrmData.QAcesso.FieldByName('EXCLUSAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para exclusão', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.QSimilarBeforeEdit(DataSet: TDataSet);
begin
 if FrmData.QAcesso.FieldByName('ALT_PRODUTOS').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para alteração', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.QSimilarBeforePost(DataSet: TDataSet);
begin
...
procedure TFrmProdutos.QSimilarNewRecord(DataSet: TDataSet);
begin
  DataSet['PRODUTO_ID'] := QTabela.FieldByName('PRODUTO_ID').AsInteger;
  DataSet['DATA']       := Date;
end;

procedure TFrmProdutos.QTabelaAfterOpen(DataSet: TDataSet);
begin
...
procedure TFrmProdutos.pgqryQFabricanteBeforeDelete(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('EXCLUSAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para exclusão', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.pgqryQFabricanteBeforeEdit(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('ALT_PRODUTOS').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para alteração', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.pgqryQFabricanteBeforePost(DataSet: TDataSet);
begin
  if (QFabricante.FieldByName('COD_FABRICANTE').AsString = '') then
  begin
    Application.MessageBox('Código do Fabricante não pode ser vazio', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.pgqryQFabricanteNewRecord(DataSet: TDataSet);
begin
  DataSet['PRODUTO_ID'] := QTabela.FieldByName('PRODUTO_ID').AsInteger;
end;

procedure TFrmProdutos.pgqryQProducaoAfterDelete(DataSet: TDataSet);
var
Vr_Produto, Vr_Custo_Produto: Real;
begin
...
procedure TFrmProdutos.pgqryQProducaoAfterPost(DataSet: TDataSet);
var
Vr_Produto , Vr_Custo_Produto: Real;
...
procedure TFrmProdutos.pgqryQProducaoBeforeDelete(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('EXCLUSAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para exclusão', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.pgqryQProducaoBeforeEdit(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('ALT_PRODUTOS').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para alteração', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.pgqryQProducaoBeforePost(DataSet: TDataSet);
begin
  if (QProducao.FieldByName('QUANTIDADE').AsFloat <= 0) or (QProducao.FieldByName('QUANTIDADE').AsFloat > 9999) then
  begin
    Application.MessageBox('Quantidade inválida', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.pgqryQSerieBeforeDelete(DataSet: TDataSet);
begin
  IQuery.Sql.Clear;
  IQuery.Sql.Add('SELECT * FROM TRANSITENS_SERIE');
  IQuery.Sql.Add('WHERE');
...
procedure TFrmProdutos.pgqryQSerieBeforeEdit(DataSet: TDataSet);
begin
  IQuery.Sql.Clear;
  IQuery.Sql.Add('SELECT * FROM TRANSITENS_SERIE');
  IQuery.Sql.Add('WHERE');
...
procedure TFrmProdutos.ibqryQControladosBeforeDelete(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('EXCLUSAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para exclusão', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.ibqryQControladosBeforeEdit(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('ALT_PRODUTOS').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para alteração', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.ibqryQControladosBeforePost(DataSet: TDataSet);
begin
...
procedure TFrmProdutos.ibqryQControladosNewRecord(DataSet: TDataSet);
begin
  DataSet['PRODUTO_ID'] := QTabela.FieldByName('PRODUTO_ID').AsInteger;
end;

procedure TFrmProdutos.ibqryQFabricanteBeforeDelete(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('EXCLUSAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para exclusão', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.ibqryQFabricanteBeforeEdit(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('ALT_PRODUTOS').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para alteração', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.ibqryQFabricanteBeforePost(DataSet: TDataSet);
begin
  if (QFabricante.FieldByName('COD_FABRICANTE').AsString = '') then
  begin
    Application.MessageBox('Código do Fabricante não pode ser vazio', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.ibqryQFabricanteNewRecord(DataSet: TDataSet);
begin
  DataSet['PRODUTO_ID'] := QTabela.FieldByName('PRODUTO_ID').AsInteger;
end;

procedure TFrmProdutos.ibqryQProducaoAfterDelete(DataSet: TDataSet);
var
Vr_Produto, Vr_Custo_Produto: Real;
begin
...
procedure TFrmProdutos.ibqryQProducaoAfterPost(DataSet: TDataSet);
var
Vr_Produto , Vr_Custo_Produto: Real;
...
procedure TFrmProdutos.ibqryQProducaoBeforeDelete(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('EXCLUSAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para exclusão', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.ibqryQProducaoBeforeEdit(DataSet: TDataSet);
begin
  if FrmData.QAcesso.FieldByName('ALT_PRODUTOS').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para alteração', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.ibqryQProducaoBeforePost(DataSet: TDataSet);
begin
  if (QProducao.FieldByName('QUANTIDADE').AsFloat <= 0) or (QProducao.FieldByName('QUANTIDADE').AsFloat > 9999) then
  begin
    Application.MessageBox('Quantidade inválida', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmProdutos.ibqryQProducaoNewRecord(DataSet: TDataSet);
begin
  DataSet['PRODUTO_ID'] := QTabela.FieldByName('PRODUTO_ID').AsInteger;
end;

procedure TFrmProdutos.ibqryQSerieBeforeDelete(DataSet: TDataSet);
begin
  IQuery.Sql.Clear;
  IQuery.Sql.Add('SELECT * FROM TRANSITENS_SERIE');
  IQuery.Sql.Add('WHERE');
...
procedure TFrmProdutos.ibqryQSerieBeforeEdit(DataSet: TDataSet);
begin
  IQuery.Sql.Clear;
  IQuery.Sql.Add('SELECT * FROM TRANSITENS_SERIE');
  IQuery.Sql.Add('WHERE');
...
procedure TFrmProdutos.ibqryQSerieBeforePost(DataSet: TDataSet);
begin
...
procedure TFrmProdutos.ibqryQSerieNewRecord(DataSet: TDataSet);
begin
  DataSet['PRODUTO_ID'] := QTabela.FieldByName('PRODUTO_ID').AsInteger;
end;
...
procedure TFrmProdutos.REFERENCIAExit(Sender: TObject);
begin
  if (Operacao = 'Inserindo') and (REFERENCIA.Text <> '') then
  begin
    IQuery.Sql.Clear;
...
procedure TFrmProdutos.Set_Campos(Vazio: Boolean);
var
I: Integer;
Temp: TComponent;
Foto1: TStream;
...
begin
  ...
  begin
    ...
    begin
     ...
     produto_id_matriz.Value :=  QTabela.FieldByName('PRODUTO_ID').AsInteger;
...
procedure TFrmProdutos.SimilarShow(Sender: TObject);
begin
  QSimilar.Close;
...
procedure TFrmProdutos.btnCompClick(Sender: TObject);
begin
  try
...
procedure TFrmProdutos.btnCst_Pis_EntrClick(Sender: TObject);
begin
  CST_PIS_ENTR.Text := GetConsulta_CST('CST_PIS', CST_PIS_ENTR.Text);
end;

procedure TFrmProdutos.btnCst_Cofins_EntrClick(Sender: TObject);
begin
  CST_COFINS_ENTR.Text := GetConsulta_CST('CST_COFINS', CST_COFINS_ENTR.Text);
end;

procedure TFrmProdutos.btnNat_RecClick(Sender: TObject);
begin
...
procedure TFrmProdutos.btnNCMClick(Sender: TObject);
begin
...
procedure TFrmProdutos.btnNextClick(Sender: TObject);
begin
  if not QTabela.Eof then
  begin
    QTabela.Next;
...
procedure TFrmProdutos.TabSheet12Show(Sender: TObject);
begin
...
procedure TFrmProdutos.TabSheet13Show(Sender: TObject);
begin
 Qlote.Close;
 Qlote.ParamByName('PRODUTO_ID').AsInteger := QTabela.FieldByName('PRODUTO_ID').AsInteger;
 Qlote.Prepare;
...
procedure TFrmProdutos.TabSheet14Show(Sender: TObject);
begin
  QDesagregacao.Close;
  QDesagregacao.ParamByName('PRODUTO_ID').AsInteger := QTabela.FieldByName('PRODUTO_ID').AsInteger;
  QDesagregacao.Prepare;
...
procedure TFrmProdutos.TabSheet5Show(Sender: TObject);
begin
  QFabricante.Close;
  QFabricante.ParamByName('PRODUTO_ID').AsInteger := QTabela.FieldByName('PRODUTO_ID').AsInteger;
  QFabricante.Prepare;
...
procedure TFrmProdutos.TabSheet6Show(Sender: TObject);
begin
  QProducao.Close;
  QProducao.ParamByName('PRODUTO_ID').AsInteger := QTabela.FieldByName('PRODUTO_ID').AsInteger;
  QProducao.Prepare;
...
procedure TFrmProdutos.TabSheet7Show(Sender: TObject);
begin
  QSerie.Close;
...
procedure TFrmProdutos.UNIDADE_VENDAExit(Sender: TObject);
begin
...
procedure TFrmProdutos.btnCestClick(Sender: TObject);
begin
...
procedure TFrmProdutos.btnComeca_ComClick(Sender: TObject);
begin
  Begin
...
procedure TFrmProdutos.btnComposicaoClick(Sender: TObject);
begin
  IQuery.Sql.Clear;
...
procedure TFrmProdutos.btnconsultabarraClick(Sender: TObject);
begin
...
procedure TFrmProdutos.btnCst_CofinsClick(Sender: TObject);
begin
  CST_COFINS.Text := GetConsulta_CST('CST_COFINS', CST_COFINS.Text);
end;

procedure TFrmProdutos.btnCst_PisClick(Sender: TObject);
begin
...
procedure TFrmProdutos.btnDiscardClick(Sender: TObject);
begin
  Botoes_Normal;
  Set_Campos(False);
...
procedure TFrmProdutos.btnEmpresaClick(Sender: TObject);
begin
  try
...
procedure TFrmProdutos.btnFamiliaClick(Sender: TObject);
begin
  try
...
procedure TFrmProdutos.btnGeneroClick(Sender: TObject);
begin
...
procedure TFrmProdutos.btnImprimeClick(Sender: TObject);
var
ID: Integer;
InputString:string;
begin
...
procedure TFrmProdutos.RDprint1NewPage(Sender: TObject; Pagina: Integer);
begin 
...
procedure TFrmProdutos.btnInsertClick(Sender: TObject);
begin
...
procedure TFrmProdutos.BtnInventarioClick(Sender: TObject);
var
InputString:string;
Id_Trans: Integer;
Vl_Trans: Real;
...
procedure TFrmProdutos.btnLocalizacaoClick(Sender: TObject);
begin
  try
...
procedure TFrmProdutos.btnPriorClick(Sender: TObject);
begin
  if not QTabela.Bof then
  begin
    QTabela.Prior;
...
begin
  ...
  Begin
    ...
    QReplicar_Produto.Sql.Add('INSERT INTO PRODUTOS(PRODUTO_ID , '+
                              ...
                              'MD5,             SPED,            STATUS, CEST, PRODUTO_ID_MATRIZ)');
    QReplicar_Produto.Sql.Add('SELECT :PRODUTO_ID, ' +
                              ...
                              'PAR_FATURAMENTO, VENDA_MEDIA_PON, VENDA_MEDIA_SEM, ' +
                              'DESV_PAD_SEM,    VINCULO,         MEDIA_CONSUMO, ' +
                              'MD5,             SPED,            STATUS,CEST, :PRODUTO_ID');
...
procedure TFrmProdutos.btnRetornaClick(Sender: TObject);
begin
  Close;
end;
...
begin
  ...
  begin
    ...
    Insert;
      ...
      Qupdate.Sql.Text := 'UPDATE PRODUTOS SET PRODUTO_ID_MATRIZ = :PRODUTO_ID WHERE PRODUTO_ID = :PRODUTO_ID';
      QUpdate.ParamByName('PRODUTO_ID').AsInteger := QTabela.FieldByName('PRODUTO_ID').AsInteger;
      QUpdate.Prepare;
      QUpdate.ExecSQL;
...
procedure TFrmProdutos.btnSub_TipoClick(Sender: TObject);
begin
  try
...
procedure TFrmProdutos.btnTributoClick(Sender: TObject);
begin
  try
...
procedure TFrmProdutos.Btn_embcpClick(Sender: TObject);
begin
  UNIDADE.Text := GetConsulta_CST('EMBALAGEM', UNIDADE.Text);
end;

procedure TFrmProdutos.Btn_embvdClick(Sender: TObject);
begin
  UNIDADE_VENDA.Text := GetConsulta_CST('EMBALAGEM', UNIDADE_VENDA.Text);
end;

procedure TFrmProdutos.btn_load_imageClick(Sender: TObject);
var
CaminhoFoto : String;
begin
...
procedure TFrmProdutos.btnTransferenciaClick(Sender: TObject);
begin
Transferencia_Estoque(QTabela.FieldByName('PRODUTO_ID').AsInteger);
end;

procedure TFrmProdutos.cad_simplesClick(Sender: TObject);
begin
if CAD_SIMPLES.Checked then
   Begin
   NCM.Enabled            := False;
...
procedure TFrmProdutos.btnParcialClick(Sender: TObject);
var
...
procedure TFrmProdutos.COD_BARRAExit(Sender: TObject);
begin
...
procedure TFrmProdutos.COD_ORIGINALExit(Sender: TObject);
begin
  if (Operacao = 'Inserindo') and (COD_ORIGINAL.Text <> '') then
  begin
    IQuery.Sql.Clear;
...
procedure TFrmProdutos.COFINSExit(Sender: TObject);
begin
...
procedure TFrmProdutos.COFINS_ENTRExit(Sender: TObject);
begin
...
procedure TFrmProdutos.Comeca_ComEnter(Sender: TObject);
begin
  Comeca_Com.Text := '';
end;

procedure TFrmProdutos.Comeca_ComKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    btnComeca_ComClick(Sender);
end;

procedure TFrmProdutos.ConsultaShow(Sender: TObject);
begin
...
procedure TFrmProdutos.CST_COFINSChange(Sender: TObject);
begin
  CST_PIS.Text := CST_COFINS.Text; 
end;

procedure TFrmProdutos.CST_COFINS_ENTRChange(Sender: TObject);
begin
  CST_PIS_ENTR.Text := CST_COFINS_ENTR.Text;
end;

procedure TFrmProdutos.CST_PISChange(Sender: TObject);
begin
...
procedure TFrmProdutos.CST_PIS_ENTRChange(Sender: TObject);
begin
...
procedure TFrmProdutos.CTRL_SERIEChange(Sender: TObject);
begin
...
procedure TFrmProdutos.DBGrid1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
InputString: String;
Codigo_Valido: Boolean;
...
procedure TFrmProdutos.dbgrid_loteKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmProdutos.DESCRICAOExit(Sender: TObject);
begin
  if ((Operacao = 'Inserindo') or (Operacao = 'Alterando')) and (FANTASIA.Text = '') then
    FANTASIA.Text := Copy(DESCRICAO.Text, 1, 24);
end;

procedure TFrmProdutos.DESCRICAOKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmProdutos.FAMILIA_IDExit(Sender: TObject);
begin
...
begin
  ...
  CmdSelect := QTabela.Sql.Text;
   ...
   CmdSelectNull := CmdSelectNull + 'AND DESCRICAO ILIKE :DESCRICAO AND (EMPRESA_ID = ' + FrmData.QAcesso.FieldByName('EMPRESA_ID').AsString + ')';
  ...
  QTabela.ParamByName('DESCRICAO').AsString := 'A%';
...
procedure TFrmProdutos.Grid_DesagregacaoColExit(Sender: TObject);
begin
...
procedure TFrmProdutos.Grid_DesagregacaoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmProdutos.Grid_DesagregacaoKeyPress(Sender: TObject;
  var Key: Char);
begin
if Key = #13 then
...
procedure TFrmProdutos.Grid_FabricanteColExit(Sender: TObject);
begin
...
procedure TFrmProdutos.Grid_FabricanteKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmProdutos.Grid_FabricanteKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    Keybd_Event(VK_TAB, 0, 0, 0);
...
procedure TFrmProdutos.Grid_Localizacao_EstoqueDrawColumnCell(Sender: TObject;
...
procedure TFrmProdutos.Grid_LoteDrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
...
procedure TFrmProdutos.Grid_LoteKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmProdutos.Grid_LoteKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    Keybd_Event(VK_TAB, 0, 0, 0);
...
procedure TFrmProdutos.Grid_ProducaoColExit(Sender: TObject);
begin
...
procedure TFrmProdutos.Grid_ProducaoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmProdutos.Grid_ProducaoKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    Keybd_Event(VK_TAB, 0, 0, 0);
...
procedure TFrmProdutos.Grid_SerieKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
InputString: String;
begin
...
procedure TFrmProdutos.Grid_SerieKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    Keybd_Event(VK_TAB, 0, 0, 0);
...
procedure TFrmProdutos.Grid_SimilarColExit(Sender: TObject);
begin
...
procedure TFrmProdutos.Grid_SimilarKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmProdutos.Grid_SimilarKeyPress(Sender: TObject; var Key: Char);
begin
if Key = #13 then
    Keybd_Event(VK_TAB, 0, 0, 0);
...
procedure TFrmProdutos.GRUPO_IDExit(Sender: TObject);
begin
  DetailSearch('Grupo');
end;
