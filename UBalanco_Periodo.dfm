object FrmBalanco_Periodo: TFrmBalanco_Periodo
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Balan'#231'o do Per'#237'odo (Custos)'
  ClientHeight = 163
  ClientWidth = 326
  Color = clBtnFace
  ...
  object Balanco: TQuickRep
    ...
    PrintIfEmpty = True
    ReportTitle = 'Balan'#231'o do Per'#237'odo'
    SnapToGrid = True
    Units = MM
    Zoom = 100
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel3: TQRLabel
        ...
        Alignment = taCenter
        AlignToBand = True
        Caption = '*** BALAN'#199'O DO PER'#205'ODO (CUSTOS) ***'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
