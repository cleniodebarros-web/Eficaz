object FrmTrans_Devolucao_Compra: TFrmTrans_Devolucao_Compra
    ...
    object Manutencao: TTabSheet
      ...
      object Pg_Simples: TPageControl
        ...
        object TabSheet3: TTabSheet
          ...
          object Grid_Saidas: TDBGrid
            Left = 3
            Top = 3
            Width = 492
            Height = 120
            DataSource = Saida_Notas
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clWindowText
            Font.Height = -9
            Font.Name = 'Tahoma'
  ...
  object QSub_Detail: TFDQuery
    ...
    SQL.Strings = (
      ...
      'WHERE'
      '(TRANSACAO_ID = :TRANSACAO_ID) ORDER BY SEQUENCIA')
    Left = 248
    Top = 200
    ParamData = <
      item
  ...
  object Saida_Notas: TDataSource
    DataSet = QSaidas_Notas
    Left = 344
    Top = 224
  end
  object QSaidas_Notas: TFDQuery
    Connection = FrmData.DbF_Eficaz
    FetchOptions.AssignedValues = [evAutoFetchAll]
    FetchOptions.AutoFetchAll = afDisable
    SQL.Strings = (
      'select saida_id, num_doc, chave_nfe,dt_emissao'
      'from transitens_notas where transacao_id = :transacao_id')
    Left = 400
    Top = 224
    ParamData = <
      item
