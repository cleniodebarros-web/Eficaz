object FrmRelAgenda_Ordens_Servico_RDP: TFrmRelAgenda_Ordens_Servico_RDP
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Agenda de Ordens de Servi'#231'o'
  ClientHeight = 447
  ClientWidth = 326
  Color = clBtnFace
  ...
  object Rel_Movimento: TCheckBox
    Left = 8
    Top = 334
    Width = 194
    Height = 17
    Caption = 'Relat'#243'rio por data de Movimento'
    TabOrder = 19
  end
