object FrmBoletos_Duplicatas: TFrmBoletos_Duplicatas
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Boletos/Duplicatas'
  ClientHeight = 307
  ClientWidth = 340
  Color = clBtnFace
  ...
  object Carne: TQuickRep
    ...
    PrinterSettings.ColorOption = 0
    PrintIfEmpty = True
    ReportTitle = 'Carn'#234' de Cobran'#231'a'
    SnapToGrid = True
    Units = Inches
    Zoom = 100
    PrevFormStyle = fsNormal
