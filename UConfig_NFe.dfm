object FrmConfig_NFe: TFrmConfig_NFe
  ...
  object GroupBox2: TGroupBox
    ...
    object Label13: TLabel
      ...
      Width = 129
      Height = 13
      Caption = 'IdCSC(NFC-e)/Criptografia'
    end
    ...
    object cbLT_TLSv1_2: TCheckBox
      Left = 10
      Top = 213
      Width = 170
      Height = 17
      Caption = 'Utilzar Ssl-Type(LT_TLSv1_2 )'
      TabOrder = 6
    end
    object IdCSC: TEdit
      Left = 8
    ...
    object Tp_criptografia: TComboBox
      Left = 207
      Top = 152
      Width = 83
      Height = 21
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet4: TTabSheet
      Caption = 'Informa'#231#245'es Adicionais(CTE)'
      ImageIndex = 3
      object Inf_Adicional_Cte: TMemo
        Left = 10
        Top = 4
        Width = 532
        Height = 65
