object FrmRel_Acomp_Restricoes_Desconto: TFrmRel_Acomp_Restricoes_Desconto
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Relat'#243'rio Acomp. Restri'#231'oes e Descontos'
  ClientHeight = 137
  ClientWidth = 344
  Color = clBtnFace
  ...
  object Rel_Vendas_Operador: TQuickRep
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel3: TQRLabel
        ...
        Alignment = taCenter
        AlignToBand = True
        Caption = '***ACOMPANHAMENTO DE RESTRI'#199'OES E DESCONTOS***'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
