object FrmRel_mapa_controle_movim_mensal: TFrmRel_mapa_controle_movim_mensal
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Mapa de Controle Movimento Mensal(G'#225's)'
  ClientHeight = 128
  ClientWidth = 366
  Color = clBtnFace
