object FrmRel_Controle_Validade: TFrmRel_Controle_Validade
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Controle de Validade dos Produtos'
  ClientHeight = 119
  ClientWidth = 323
  Color = clBtnFace
  ...
  object Controle_Validade: TQuickRep
    Left = 64
    Top = 270
    Width = 794
    Height = 1123
  ...
  object QRel: TFDQuery
    ...
    SQL.Strings = (
      'select lote_produtos.* , produtos.descricao,fornecedores.nome'
      'from lote_produtos'
      
        'inner join produtos on produtos.produto_id = lote_produtos.produ' +
        'to_id'
      
        'INNER JOIN FORNECEDORES  ON LOTE_PRODUTOS.FORNECEDOR_ID = LOTE_P' +
        'RODUTOS.FORNECEDOR_ID'
      'order by dt_validade,produto_id,lote_id'
      '')
    Left = 96
    Top = 81
  end
