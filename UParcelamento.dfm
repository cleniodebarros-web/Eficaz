object FrmParcelamento: TFrmParcelamento
  ...
  object Label3: TLabel
    ...
    Width = 152
    Height = 13
    Caption = 'Intervalo dias entre as parcelas'
  end
  object Label2: TLabel
    ...
    Width = 157
    Height = 13
    Caption = 'Caixa/Banco (se a 1'#170' for a vista)'
  end
  ...
  object Label4: TLabel
    ...
    Width = 146
    Height = 13
    Caption = 'Desconto no Boleto (Compras)'
  end
  ...
  object Desc_Boleto: TCurrencyEdit
    Left = 173
    Top = 57
    Width = 67
    Height = 21
  ...
  object chk_acrescimo: TCheckBox
    Left = 8
    Top = 110
    Width = 201
    Height = 17
    Caption = 'Acr'#233'scimo no Boleto de Compras'
    TabOrder = 6
    OnClick = chk_acrescimoClick
  end
