...
uses                                       
  ...
  ComCtrls, Grids, DBGrids, IBUpdateSQL, RDprint, FireDAC.Stan.Intf,
...
type
  TFrmCTe = class(TForm)
    ...
    IQuery: TFDQuery;
    QNotas: TFDQuery;
    QConfig_CTEFiscal: TFDQuery;
    QItens: TFDQuery;
    USql_Notas: TFDUpdateSQL;
    PageControl1: TPageControl;
    Tab_Remetente: TTabSheet;
    Label36: TLabel;
    ...
    Label25: TLabel;
    N_EXPEDIDOR: TEdit;
    UF_EXPEDIDOR: TComboBox;
    Label26: TLabel;
    Label27: TLabel;
    IBGE_EXPEDIDOR: TEdit;
    BAIRRO_EXPEDIDOR: TEdit;
    Label28: TLabel;
    BtnIbgeExpedidor: TSpeedButton;
    CEP_EXPEDIDOR: TMaskEdit;
    Label29: TLabel;
    MUNICIPIO_EXPEDIDOR: TEdit;
    ENDERECO_EXPEDIDOR: TEdit;
    NOME_EXPEDIDOR: TEdit;
    CNPJ_EXPEDIDOR: TEdit;
    INSCRICAO_EXPEDIDOR: TEdit;
    Label30: TLabel;
    btnexpedidor: TSpeedButton;
    TabSheet4: TTabSheet;
    Label31: TLabel;
    Label32: TLabel;
    Label42: TLabel;
    ...
    Label44: TLabel;
    N_RECEBEDOR: TEdit;
    UF_RECEBEDOR: TComboBox;
    Label45: TLabel;
    Label47: TLabel;
    IBGE_RECEBEDOR: TEdit;
    BAIRRO_RECEBEDOR: TEdit;
    Label48: TLabel;
    SpeedButton3: TSpeedButton;
    CEP_RECEBEDOR: TMaskEdit;
    Label49: TLabel;
    MUNICIPIO_RECEBEDOR: TEdit;
    ENDERECO_RECEBEDOR: TEdit;
    NOME_RECEBEDOR: TEdit;
    CNPJ_RECEBEDOR: TEdit;
    INSCRICAO_RECEBEDOR: TEdit;
    Label50: TLabel;
    btnrecebedor: TSpeedButton;
    Label21: TLabel;
    EMAIL_TRANSPORTADOR: TEdit;
    Label51: TLabel;
    email_expedidor: TEdit;
    Label52: TLabel;
    email_recebedor: TEdit;
    Label53: TLabel;
    RENAVAM_VEICULO: TEdit;
    Label54: TLabel;
    registro_estadual: TEdit;
    taf: TEdit;
    Label55: TLabel;
    PageControl2: TPageControl;
    Nota_Fiscal: TTabSheet;
    TabSheet5: TTabSheet;
    Grid_Notas: TDBGrid;
    StatusBar2: TStatusBar;
    TabSheet6: TTabSheet;
    Label56: TLabel;
    Municipio_Origem: TEdit;
    Label57: TLabel;
    Uf_Origem: TComboBox;
    Label58: TLabel;
    IBGe_Origem: TEdit;
    BtnIbgeOrigem: TSpeedButton;
    Label59: TLabel;
    Cep_Origem: TMaskEdit;
    Label60: TLabel;
    Municipio_Destino: TEdit;
    Label61: TLabel;
    Uf_Destino: TComboBox;
    Label62: TLabel;
    Cep_Destino: TMaskEdit;
    Label63: TLabel;
    Ibge_Destino: TEdit;
    BtnIbgeDestino: TSpeedButton;
    Label64: TLabel;
    ...
    Label68: TLabel;
    INSCRICAO_OUTROS: TEdit;
    Label69: TLabel;
    NOME_OUTROS: TEdit;
    Label70: TLabel;
    ENDERECO_OUTROS: TEdit;
    Label72: TLabel;
    NRO_OUTROS: TEdit;
    BAIRRO_OUTROS: TEdit;
    Label73: TLabel;
    MUNICIPIO_OUTROS: TEdit;
    Label74: TLabel;
    UF_OUTROS: TComboBox;
    Label75: TLabel;
    Rel_Coleta: TQuickRep;
    QRShape1: TQRShape;
    Button2: TButton;
    QRShape2: TQRShape;
    QRLabel1: TQRLabel;
    ...
    Relatorio_Cte: TfrxReport;
    frxDBDataset1: TfrxDBDataset;
    QLayoutFastReport: TFDQuery;
    Button3: TButton;
    Chk_Globalizado: TCheckBox;
    cte_globalizado: TCurrencyEdit;
    Label76: TLabel;
    IBGE_OUTROS: TEdit;
    btnIBGEOutros: TSpeedButton;
    Label77: TLabel;
    CEP_OUTROS: TMaskEdit;
    VisualizarCTe: TCheckBox;
    ...
    procedure INSTRUCOES_2Exit(Sender: TObject);
    procedure btnexpedidorClick(Sender: TObject);
    procedure btnrecebedorClick(Sender: TObject);
    procedure BtnIbgeOrigemClick(Sender: TObject);
    procedure BtnIbgeExpedidorClick(Sender: TObject);
    procedure BtnIbgeDestinoClick(Sender: TObject);
    procedure tafExit(Sender: TObject);
    procedure registro_estadualExit(Sender: TObject);
    procedure btnOutrosClick(Sender: TObject);
    procedure Button2Click(Sender: TObject);
    procedure Button3Click(Sender: TObject);
    procedure Relatorio_CteLoadTemplate(Report: TfrxReport;
      const TemplateName: string);
    procedure btnIBGEOutrosClick(Sender: TObject);
    procedure TOMADOR_SERVICOChange(Sender: TObject);
  private
...
var
  FrmCTe: TFrmCTe;
  ID,Transmitido: Integer;
  GeraXML,e_mail: Boolean;
  Cod_CFOP: String;

  procedure CTe(Transacao_Id,enviado: Integer; CFOP: String);
  Procedure EnviarEmailCte(email:string);

implementation

uses
  UPrincipal, UData, pcnConversao,pcteconversaocte, UConsulta, UConsulta_CFOP,UPasswordDlg,UAcesso,UConsulta_CST;

{$R *.dfm}

Procedure EnviarEmailCte(email:string);
var
IniFile, edtSmtpHost, edtSmtpPort, edtSmtpUser, edtSmtpPass, edtEmailAssunto,id_cpf,id_nome: String;
...
Begin
  ...
  if FrmPrincipal.QConfig_Nfiscal.FieldByName('SERVIDOR_SMTP').AsString = '' then
  Begin
    ...
    FrmPrincipal.MemoResp.Lines.Add('Segue em anexo : Cte Nº: ' + StrZero(IntToStr(FrmPrincipal.ACBrCTe1.Conhecimentos.Items[0].CTe.Ide.nCT), 9, 0));
    ...
    if FrmCte.QParceiro.FieldByName('CLIENTE_ID').AsInteger > 0 then
    FrmPrincipal.MemoResp.Lines.Add('Cliente: ' + FrmCte.QParceiro.FieldByName('NOME').AsString + ' CNPJ/CPF: ' + FrmCte.QParceiro.FieldByName('CNPJ').AsString);
    //Else
    //FrmPrincipal.MemoResp.Lines.Add('Cliente: ' + FrmNfe.QParceiro.FieldByName('NOME').AsString  + ' CNPJ/CPF: ' + FrmNfe.QParceiro.FieldByName('CNPJ').AsString);

    FrmPrincipal.MemoResp.Lines.Add('');
    FrmPrincipal.MemoResp.Lines.Add('Chave da Cte: ' + Copy(FrmPrincipal.ACBrNFe1.NotasFiscais.Items[0].NFe.infNFe.ID, 4, 44));
    FrmPrincipal.MemoResp.Lines.Add('');
    FrmPrincipal.MemoResp.Lines.Add('');
    FrmPrincipal.MemoResp.Lines.Add('');
    ...
    FrmPrincipal.ACBrCTe1.Conhecimentos.Items[0].EnviarEmail(email, edtEmailAssunto ,
  ...
  Begin
    ...
    e_mail := False;
      ...
      try
        ...
        edtEmailAssunto := 'Envio Nota Fiscal Eletrônica Sistema Eficaz';

        if  FrmPrincipal.QConfig_Nfiscal.FieldByName('SSL').AsString = 'True' Then
        cbEmailSSL      := True
        Else
        cbEmailSSL      := False;
    ...
    FrmPrincipal.MemoResp.Lines.Add('');
    FrmPrincipal.MemoResp.Lines.Add('Chave da CTe: ' + Copy(FrmPrincipal.ACBrCTe1.Conhecimentos.Items[0].Cte.infCTe.ID, 4, 44));
    FrmPrincipal.MemoResp.Lines.Add('');
    FrmPrincipal.MemoResp.Lines.Add('');
    FrmPrincipal.MemoResp.Lines.Add('');
    FrmPrincipal.MemoResp.Lines.Add('**********************Sistema Eficaz(38)37411478**********************');
  ...
  if e_mail then
  //FrmPrincipal.mdescricao.Caption := 'E-mail enviado:' + email;

  // Application.MessageBox(Pchar('E-mail enviado:' + email), PChar(Msg_Title), mb_IconInformation);
...
begin
  ...
  begin
    ...
    begin
      ...
      IF QTabela.FieldByName('CTE_GLOBALIZADO').AsInteger = 0 Then
      chk_Globalizado.Checked := False
      Else
      chk_Globalizado.Checked := True;
...
procedure TFrmCTe.btnIBGEOutrosClick(Sender: TObject);
begin
  try
    IBGE_OUTROS.Text := IntToStr(GetConsulta('IBGE', 0, 0, StrToInt(IBGE_OUTROS.Text)));
  except
    IBGE_OUTROS.Text := IntToStr(GetConsulta('IBGE', 0, 0, 0));
  end;
end;

procedure TFrmCTe.btnOutrosClick(Sender: TObject);
var
forne:integer;
begin
Forne := GetConsulta('CLIENTES', 0, 0, 0);
  ...
  begin
    ...
    NOME_OUTROS.Text      := IQuery.FieldByName('NOME').AsString;
    CNPJ_OUTROS.Text      := SemMascara(IQuery.FieldByName('CNPJ').AsString);
    ENDERECO_OUTROS.Text  := Copy(IQuery.FieldByName('ENDERECO').AsString,1,50);
    MUNICIPIO_OUTROS.Text := IQuery.FieldByName('MUNICIPIO').AsString;
    NRO_OUTROS.Text       := IQuery.FieldByName('NUMERO').AsString;
    BAIRRO_OUTROS.Text    := IQuery.FieldByName('BAIRRO').AsString;
    UF_OUTROS.Text        := IQuery.FieldByName('ESTADO').AsString;
    IBGE_OUTROS.Text      := IQuery.FieldByName('IBGE').AsString;
    CEP_OUTROS.Text       := IQuery.FieldByName('CEP').AsString;


    if IQuery.FieldByName('INSCRICAO').AsString = '' then
    INSCRICAO_OUTROS.Text := 'ISENTO'
    Else
    INSCRICAO_OUTROS.Text := IQuery.FieldByName('INSCRICAO').AsString;

  end;
end;


procedure TFrmCTe.tafExit(Sender: TObject);
begin
if taf.Text <> '' then
registro_estadual.Text := '';
end;

procedure TFrmCTe.TOMADOR_SERVICOChange(Sender: TObject);
begin
  if TOMADOR_SERVICO.Text = 'OUTROS' then
    PageControl1.ActivePage := TabSheet1;
end;

procedure TFrmCTe.BtnIbgeDestinoClick(Sender: TObject);
begin
  try
    IBGE_Destino.Text := IntToStr(GetConsulta('IBGE', 0, 0, StrToInt(IBGE_Destino.Text)));
  except
    IBGE_Destino.Text := IntToStr(GetConsulta('IBGE', 0, 0, 0));
  end;

  QSearch.Sql.Clear;
  QSearch.Sql.Add('SELECT DESCRICAO,UF_SIGLA FROM IBGE WHERE CODIGO = :CODIGO');
  QSearch.ParamByName('CODIGO').AsString := IBGE_Destino.Text;
  QSearch.Prepare;
  QSearch.Open;

  if not QSearch.IsEmpty Then
  Begin
   Municipio_Destino.Text := QSearch.FieldByname('DESCRICAO').AsString;
   Uf_Destino.text        := QSearch.FieldByname('UF_SIGLA').AsString;
  End;


end;

procedure TFrmCTe.BtnIbgeExpedidorClick(Sender: TObject);
begin
 try
    IBGE_Expedidor.Text := IntToStr(GetConsulta('IBGE', 0, 0, StrToInt(IBGE_expedidor.Text)));
  except
    IBGE_expedidor.Text := IntToStr(GetConsulta('IBGE', 0, 0, 0));
  end;

end;

procedure TFrmCTe.BtnIbgeOrigemClick(Sender: TObject);
begin
try
    IBGE_Origem.Text := IntToStr(GetConsulta('IBGE', 0, 0, StrToInt(IBGE_Origem.Text)));
  except
    IBGE_Origem.Text := IntToStr(GetConsulta('IBGE', 0, 0, 0));
  end;

  QSearch.Sql.Clear;
  QSearch.Sql.Add('SELECT DESCRICAO,UF_SIGLA FROM IBGE WHERE CODIGO = :CODIGO');
  QSearch.ParamByName('CODIGO').AsString := IBGE_Origem.Text;
  QSearch.Prepare;
  QSearch.Open;

  if not QSearch.IsEmpty Then
  Begin
   Municipio_Origem.Text := QSearch.FieldByname('DESCRICAO').AsString;
   Uf_origem.text        := QSearch.FieldByname('UF_SIGLA').AsString;
  End;
...
begin
  ...
  IQuery.Prepare;
  IQuery.ExecSql;
 // Showmessage('insert:' + QTransacao.FieldByName('NUM_DOC').AsString + ' ' + QTransacao.FieldByName('TRANSACAO_ID').AsString  );

end;

procedure TFrmCTe.INSTRUCOES_2Exit(Sender: TObject);
begin
INSTRUCOES_2.Text := StrZero(INSTRUCOES_2.Text,8,0)
end;
...
begin
  ...
  bEGIN
  REGISTRO_ESTADUAL.Enabled := True;
  TAF.Enabled              := True;
  end
  eLSE
  bEGIN
  REGISTRO_ESTADUAL.Enabled := False;
  TAF.Enabled              := False;
  end;
end;
...
begin
  ...
  IQuery.ParamByName('NUM_DOC').AsInteger   := StrToInt(NO_DOC_FISCAL.Text);
...
begin
  ...
  if (QTransacao.FieldByName('MODELO').AsString = '67')  and (LOCAL_EMBARQUE.Text =  '') then
  Begin
    Application.MessageBox('Descrição do Serviço Inválido.', PChar(Msg_Title), mb_IconStop);
    TabSheet2.Show;
    LOCAL_EMBARQUE.Color := clYellow;
    LOCAL_EMBARQUE.SetFocus;
    exit;
  end;
  ...
  IF TIPO_SERVICO.Text = 'SUBCONTRATAÇÃO' then
  begin


    if length(CNPJ_EXPEDIDOR.Text) <= 11 then
    begin
      if not ValidCpf(StrZero(CNPJ_EXPEDIDOR.Text, 11, 0)) then
      begin
        Application.MessageBox('Dígito Verificador do CPF inválido', PChar(Msg_Title), mb_IconStop);
        CNPJ_EXPEDIDOR.Color := clYellow;
        CNPJ_EXPEDIDOR.SetFocus;
        exit;
      end;
    end
    else
    begin
      if not ValidCgc(StrZero(CNPJ_EXPEDIDOR.Text, 14, 0)) then
      begin
        Application.MessageBox('Dígito Verificador do CNPJ inválido', PChar(Msg_Title), mb_IconStop);
        CNPJ_EXPEDIDOR.Color := clYellow;
        CNPJ_EXPEDIDOR.SetFocus;
    ...
    if (UF_EXPEDIDOR.Text <> '  ') and (not ChecaEstado(UF_EXPEDIDOR.Text)) then
    begin
      Application.MessageBox('Estado inválido', PChar(Msg_Title), mb_IconStop);
      UF_EXPEDIDOR.Color := clYellow;
      UF_EXPEDIDOR.SetFocus;
      exit;
    end;

    if Length(AllTrim(sub_chave_cte.Text)) <> 44 then
    Begin
      Application.MessageBox('Tamanho da Chave Cte Inválido! deve conter 44 Caracteres favor verificar a digitação!', PChar(Msg_Title), mb_IconStop);
      sub_chave_cte.Color := clYellow;
      sub_chave_cte.SetFocus;
      exit;
    End;

    if not Verifica_ChaveNfe(AllTrim(sub_chave_cte.Text)) then
    Begin
 ...
 if FINALIDADE_EMISSAO.Text = '4-CTE SUBSTITUTO' then
 Begin
  if Length(AllTrim(cte_origem.Text)) <> 44 then
  Begin
    Application.MessageBox('Tamanho da Chave Cte Inválido! deve conter 44 Caracteres favor verificar a digitação!', PChar(Msg_Title), mb_IconStop);
    cte_origem.Color := clYellow;
    cte_origem.SetFocus;
    exit;
  End;

  if not Verifica_ChaveNfe(AllTrim(cte_origem.Text)) then
  Begin
   Application.MessageBox('Dígito Verificador da Chave Cte incorreto favor verificar a digitação!', PChar(Msg_Title), mb_IconStop);
   cte_origem.Color := clYellow;
   cte_origem.SetFocus;
 ...
 End;
  ...
  if (FORMA_EMISSAO.Text <> 'CONTINGÊNCIA C/ SVCSP') AND (FORMA_EMISSAO.Text <> 'NORMAL') and (FORMA_EMISSAO.Text <> 'CONTINGÊNCIA FS') and (FORMA_EMISSAO.Text <> 'CONTINGÊNCIA C/ SCAN') and (FORMA_EMISSAO.Text <> 'CONTINGÊNCIA VIA DPEC') and (FORMA_EMISSAO.Text <> 'CONTINGÊNCIA FS-DA') then
  begin
  ...
  if (FINALIDADE_EMISSAO.Text <> '1-CTE NORMAL') and (FINALIDADE_EMISSAO.Text <> '2-CTE COMPLEMENTO') and (FINALIDADE_EMISSAO.Text <> '3-CTE ANULACÃO') and (FINALIDADE_EMISSAO.Text <> '4-CTE SUBSTITUTO')  then
  begin
  ...
  if (TOMADOR_SERVICO.Text <> 'REMETENTE') and (TOMADOR_SERVICO.Text <> 'DESTINATÁRIO') and (TOMADOR_SERVICO.Text <> 'RECEBEDOR') and (TOMADOR_SERVICO.Text <> 'EXPEDIDOR') and (TOMADOR_SERVICO.Text <> 'OUTROS') then
  begin
  ...
  if (TIPO_SERVICO.Text <> 'MULTIMODAL') and (TIPO_SERVICO.Text <> 'NORMAL') and (TIPO_SERVICO.Text <> 'SUBCONTRATAÇÃO') and (TIPO_SERVICO.Text <> 'REDESPACHO') and (TIPO_SERVICO.Text <> 'INTERMEDIÁRIO')  AND (TIPO_SERVICO.Text <> 'TRANSPORTE DE PESSOAS') then
  begin
...
procedure TFrmCTe.registro_estadualExit(Sender: TObject);
begin
if registro_estadual.Text <> '' then
Taf.Text := '';
end;

procedure TFrmCTe.Relatorio_CteLoadTemplate(Report: TfrxReport;
  const TemplateName: string);
var
  BlobStream: TStream;
...
procedure TFrmCTe.btnexpedidorClick(Sender: TObject);
var
Forne :Integer;
begin
Forne := GetConsulta('CLIENTES', 0, 0, 0);
  ...
  if not IQuery.IsEmpty then
  begin
    NOME_EXPEDIDOR.Text      := IQuery.FieldByName('NOME').AsString;
    CNPJ_EXPEDIDOR.Text      := SemMascara(IQuery.FieldByName('CNPJ').AsString);
    ENDERECO_EXPEDIDOR.Text  := Copy(IQuery.FieldByName('ENDERECO').AsString,1,50);
    MUNICIPIO_EXPEDIDOR.Text := IQuery.FieldByName('MUNICIPIO').AsString;
    N_EXPEDIDOR.Text         := IQuery.FieldByName('NUMERO').AsString;
    BAIRRO_EXPEDIDOR.Text    := IQuery.FieldByName('BAIRRO').AsString;
    UF_EXPEDIDOR.Text        := IQuery.FieldByName('ESTADO').AsString;
    IBGE_EXPEDIDOR.Text                    := IQuery.FieldByName('IBGE').AsString;
    CEP_EXPEDIDOR.Text       := IQuery.FieldByName('CEP').AsString;


    if IQuery.FieldByName('INSCRICAO').AsString = '' then
    INSCRICAO_EXPEDIDOR.Text := 'ISENTO'
    Else
    INSCRICAO_EXPEDIDOR.Text := IQuery.FieldByName('INSCRICAO').AsString;

    Email_EXPEDIDOR.Text     := IQuery.FieldByName('EMAIL').AsString;
  end;
end;
...
begin
  ...
  begin
    ...
    ENDERECO_TRANSPORTADOR.Text  := COPY(IQuery.FieldByName('ENDERECO').AsString,1,50);
...
Ini: TIniFile;
StreamMemo: TMemoryStream;
Vr_trib_acum,Vl_Trans,Vr_Carga :Real;
...
begin
  ...
  if (IQuery.IsEmpty) and (QTransacao.FieldByName('MODELO').AsString = '57')  Then
  Begin
  Nota_Fiscal.Show;
  ...
  begin
    ...
    if chk_Globalizado.Checked Then
    Cte_globalizado.value := 1
    Else
    Cte_globalizado.value := 0;
    ...
    try
      ...
      QNatoper.ParamByName('COD_CFOP').AsString := CFOP_COMPL.Text;
      ...
      else if FORMA_EMISSAO.Text = 'CONTINGÊNCIA C/ SVCSP' then
        FrmPrincipal.ACBrCTe1.Configuracoes.Geral.FormaEmissao := teSVCSP
      ...
      if QTransacao.FieldByName('MODELO').AsInteger = 57 then
        FrmPrincipal.ACBrCTe1.Configuracoes.Geral.ModeloDF := moCTe
      Else
         FrmPrincipal.ACBrCTe1.Configuracoes.Geral.ModeloDF := moCTeOS;
      ...
      begin
       // InfCTe.
        ...
        Ide.CFOP  := STrToInt(CFOP_COMPL.Text); //StrToInt(QTransacao.FieldByName('CFOP').AsString);
      ...
      {  if COND_PAGTO.ItemIndex = 0 then
        ...
        if (Insc_Dest = 'ISENTO') and (QParceiro.FieldByName('TIPO_CLIENTE').AsString = 'PESSOA FÍSICA')  Then
          ide.indIEToma :=  inNaoContribuinte

        Else  if (Insc_Dest = 'ISENTO') and (QParceiro.FieldByName('TIPO_CLIENTE').AsString = 'PESSOA JURÍDICA')  Then
          ide.indIEToma := inNaoContribuinte
        Else
       ...
       // Ide.dhCont   := QTransacao.FieldByName('DT_TRANS').AsDateTime;
        Ide.dhEmi    := StrToDateTime(DateToStr(DT_SAIDA.Date) + (hr_saida.Text));
        //Ide.h  := StrToTime(hr_saida.Text);
...
//        Ide.tpAmb
        ...
        if FINALIDADE_EMISSAO.Text = '1-CTE NORMAL' then
          Ide.tpCTe := tcNormal

        else if FINALIDADE_EMISSAO.Text = '2-CTE COMPLEMENTO' then
          Ide.tpCTe := tcComplemento

        else if FINALIDADE_EMISSAO.Text = '3-CTE ANULAÇÃO' then
          Ide.tpCTe := tcAnulacao

        else if FINALIDADE_EMISSAO.Text = '4-CTE SUBSTITUTO' then
          Ide.tpCTe := tcSubstituto;
//
        Ide.procEmi := peAplicativoContribuinte;

        IQuery.SQL.Clear;
        IQuery.SQL.Add('SELECT VERSAO FROM VERSAO');
        IQuery.Prepare;
        IQuery.Open();

        Ide.verProc  := IQuery.FieldByName('VERSAO').AsString;
...
//
        ...
        End;
         ...
         Else if TIPO_SERVICO.Text = 'TRANSPORTE DE PESSOAS' then
           Ide.tpServ           := tsTranspPessoas
         Else if TIPO_SERVICO.Text = 'MULTIMODAL' then
        ...
        // Origem da Prestação
         ...
         Ide.cMunIni  := StrToInt(IBGE.Text);//QParceiro.FieldByName('IBGE').AsInteger;
         Ide.xMunIni  := MUNICIPIO_TRANSPORTADOR.Text;//QParceiro.FieldByName('MUNICIPIO').AsString;
         Ide.UFIni    := UF_TRANSPORTADOR.Text;//QParceiro.FieldByName('ESTADO').AsString;


        if  MUNICIPIO_Origem.Text <> ''    Then
        Begin
         Ide.cMunIni  := StrToInt(IBGE_origem.Text);
         Ide.xMunIni  := MUNICIPIO_Origem.Text;
         Ide.UFIni    := UF_Origem.Text;
        End;

        if  MUNICIPIO_Destino.Text <> ''    Then
        Begin
         Ide.cMunFim  := StrToInt(IBGE_Destino.Text);
         Ide.xMunFim  := MUNICIPIO_Destino.Text;
         Ide.UFFim    := UF_Destino.Text;
        End;


        // Destino da Prestação

        if NOME_RECEBEDOR.TEXT <> '' then
        Begin

         Ide.cMunFim  := StrToInt(IBGE_RECEBEDOR.Text);
         Ide.xMunFim  := MUNICIPIO_RECEBEDOR.Text;//
         Ide.UFFim    :=  UF_RECEBEDOR.Text; //
        ...
        Begin
         ...
         Ide.cMunFim  := QParceiro.FieldByName('IBGE').AsInteger;
         Ide.xMunFim  := QParceiro.FieldByName('MUNICIPIO').AsString;
         Ide.UFFim    := QParceiro.FieldByName('ESTADO').AsString;
        End;
         }

        if (TIPO_SERVICO.Text = 'TRANSPORTE DE PESSOAS')   then
        Begin
       ...
       if FINALIDADE_EMISSAO.Text = '2-CTE COMPLEMENTO' then
       infCteComp.chave := QTransacao.FieldByName('CHAVE_NFE_REF').AsString;
      ...
      // Totamdor do Serviço no CTe 4 = Outros
        ...
        begin
          ...
          Ide.Toma4.CNPJCPF           := CNPJ_OUTROS.Text;
          Ide.Toma4.IE                := INSCRICAO_OUTROS.Text;
          Ide.Toma4.xNome             := NOME_OUTROS.Text;
          Ide.Toma4.xFant             := NOME_OUTROS.Text;
          Ide.Toma4.EnderToma.xLgr    := ENDERECO_OUTROS.Text;
          Ide.Toma4.EnderToma.nro     := NRO_OUTROS.Text;
          Ide.Toma4.EnderToma.xCpl    := '';
          Ide.Toma4.EnderToma.xBairro := BAIRRO_OUTROS.Text;
          Ide.Toma4.EnderToma.cMun    := StrToInt(IBGE_OUTROS.Text);
          Ide.Toma4.EnderToma.xMun    := MUNICIPIO_OUTROS.Text;
          Ide.Toma4.EnderToma.CEP     := StrToInt(SemMascara(CEP_OUTROS.Text));
          Ide.Toma4.EnderToma.UF      := UF_OUTROS.Text;
          Ide.Toma4.EnderToma.cPais   := 1058;
          Ide.Toma4.EnderToma.xPais   := '1058';
        end;
    ...
    //  Informações Complementares do CTe
     ...
     case DM_CNT.Conhec2EntregaTipoHora.AsInteger of
      ...
      1,2,3: begin
        ...
        if (QTransacao.FieldByName('OBSERVACAO').AsString <> '') Then
        compl.xObs :=  compl.xObs + QTransacao.FieldByName('OBSERVACAO').AsString;
       ...
       // Dados do Emitente
        ...
        Rem.xNome             := NOME_TRANSPORTADOR.TEXT;//
        Rem.xFant             := NOME_TRANSPORTADOR.TEXT;//
        Rem.CNPJCPF           := CNPJ_TRANSPORTADOR.Text;//
        Rem.IE                := INSCRICAO_TRANSPORTADOR.TEXT;//
        Rem.EnderReme.xLgr    := ENDERECO_TRANSPORTADOR.TEXT;//
        Rem.EnderReme.nro     := N_TRANSPORTADOR.TEXT;//
        Rem.EnderReme.xCpl    := ''; //
        Rem.EnderReme.xBairro := BAIRRO_TRANSPORTADOR.TEXT;//


        try
          Rem.EnderReme.cMun := StrToInt(IBGE.Text);
        except
          Rem.EnderReme.cMun := 0;
        end;
        //Rem.EnderReme.cMun    := StrToInt(QParceiro.FieldByName('IBGE').AsString);

        Rem.EnderReme.xMun    := MUNICIPIO_TRANSPORTADOR.Text;//

        try
          Rem.EnderReme.CEP := StrToInt(SemMascara(CEP_TRANSPORTADOR.Text));
        except
          Rem.EnderReme.CEP := 0;
        end;
        //Rem.EnderReme.CEP     := StrToIntDef(QParceiro.FieldByName('CEP').AsString, 0);

        Rem.EnderReme.UF      := UF_TRANSPORTADOR.Text; //
        Rem.EnderReme.cPais   := 1058;
        Rem.EnderReme.xPais   := '1058';
        ...
        TRY
          ...
          Dest.EnderDest.cMun    := StrToInt(QParceiro.FieldByName('IBGE').AsString);
        ...
        if (Tomador_Servico.Text = 'REMETENTE') then
        Begin
          Toma.xNome             := NOME_TRANSPORTADOR.TEXT;//
          Toma.xFant             := NOME_TRANSPORTADOR.TEXT;//
          Toma.CNPJCPF           := CNPJ_TRANSPORTADOR.Text;//

          if (Insc_Dest <> 'ISENTO') Then
          Toma.IE                := INSCRICAO_TRANSPORTADOR.TEXT;//

          Toma.EnderToma.xLgr    := ENDERECO_TRANSPORTADOR.TEXT;//
          Toma.EnderToma.nro     := N_TRANSPORTADOR.TEXT;//
          Toma.EnderToma.xCpl    := '';        //
          Toma.EnderToma.xBairro := BAIRRO_TRANSPORTADOR.TEXT;//


          try
            Toma.EnderToma.cMun := StrToInt(IBGE.Text);
          except
            Toma.EnderToma.cMun := 0;
          end;
          //Rem.EnderReme.cMun    := StrToInt(QParceiro.FieldByName('IBGE').AsString);

          Toma.EnderToma.xMun    := MUNICIPIO_TRANSPORTADOR.Text;//

          try
            Toma.EnderToma.CEP := StrToInt(SemMascara(CEP_TRANSPORTADOR.Text));
          except
            Toma.EnderToma.CEP := 0;
          end;
          //Rem.EnderReme.CEP     := StrToIntDef(QParceiro.FieldByName('CEP').AsString, 0);

          Toma.EnderToma.UF      := UF_TRANSPORTADOR.Text; //
          Toma.EnderToma.cPais   := 1058;
          Toma.EnderToma.xPais   := '1058';

        End
        Else if Tomador_Servico.Text = 'EXPEDIDOR' then
        Begin
          Toma.xNome              := NOME_EXPEDIDOR.TEXT;//
          Toma.CNPJCPF            := CNPJ_EXPEDIDOR.Text;//

          if (Insc_Dest <> 'ISENTO') Then
          Toma.IE                 := INSCRICAO_EXPEDIDOR.TEXT;//

          Toma.enderToma.xLgr    := ENDERECO_EXPEDIDOR.TEXT;//
          Toma.enderToma.nro     := N_EXPEDIDOR.TEXT;//
          Toma.enderToma.xCpl    := ''; //
          Toma.enderToma.xBairro := BAIRRO_EXPEDIDOR.TEXT;//

          try
           Toma.enderToma.cMun := StrToInt(IBGE_EXPEDIDOR.Text);
          except
            Toma.enderToma.cMun := 0;
          end;
          //Rem.EnderReme.cMun    := StrToInt(QParceiro.FieldByName('IBGE').AsString);

          Toma.enderToma.xMun    := MUNICIPIO_EXPEDIDOR.Text;//

          try
            Toma.enderToma.CEP := StrToInt(SemMascara(CEP_EXPEDIDOR.Text));
          except
            Toma.enderToma.CEP := 0;
          end;
          //Rem.EnderReme.CEP     := StrToIntDef(QParceiro.FieldByName('CEP').AsString, 0);

          Toma.enderToma.UF      := UF_EXPEDIDOR.Text; //
          Toma.enderToma.cPais   := 1058;
          Toma.enderToma.xPais   := '1058';
          Toma.email              := email_expedidor.text;

        End
        Else if Tomador_Servico.Text = 'RECEBEDOR' then
        Begin
          Toma.xNome             := NOME_RECEBEDOR.TEXT;//
          Toma.CNPJCPF           := CNPJ_RECEBEDOR.Text;//

          if (Insc_Dest <> 'ISENTO') Then
          Toma.IE                := INSCRICAO_RECEBEDOR.TEXT;//

          Toma.enderToma.xLgr    := ENDERECO_RECEBEDOR.TEXT;//
          Toma.enderToma.nro     := N_RECEBEDOR.TEXT;//
          Toma.enderToma.xCpl    := ''; //
          Toma.enderToma.xBairro := BAIRRO_RECEBEDOR.TEXT;//

          try
           Toma.enderToma.cMun := StrToInt(IBGE_RECEBEDOR.Text);
          except
            Toma.enderToma.cMun := 0;
          end;
          //Rem.EnderReme.cMun    := StrToInt(QParceiro.FieldByName('IBGE').AsString);

          Toma.enderToma.xMun    := MUNICIPIO_RECEBEDOR.Text;//

          try
            Toma.enderToma.CEP := StrToInt(SemMascara(CEP_RECEBEDOR.Text));
          except
            Toma.enderToma.CEP := 0;
          end;
          //Rem.EnderReme.CEP     := StrToIntDef(QParceiro.FieldByName('CEP').AsString, 0);

          Toma.enderToma.UF      := UF_RECEBEDOR.Text; //
          Toma.enderToma.cPais   := 1058;
          Toma.enderToma.xPais   := '1058';
          Toma.email              := email_recebedor.text;

        End
        Else if Tomador_Servico.Text = 'DESTINATÁRIO' then
        Begin
          TRY
          Toma.CNPJCPF           := QParceiro.FieldByName('CNPJ').AsString;
          Toma.xNome             := QParceiro.FieldByName('NOME').AsString;
          Toma.enderToma.xLgr    := QParceiro.FieldByName('ENDERECO').AsString;
          Toma.EnderToma.nro     := QParceiro.FieldByName('NUMERO').AsString;
          Toma.EnderToma.xCpl    := QParceiro.FieldByName('COMPLEMENTO').AsString;;
          Toma.EnderToma.xBairro := QParceiro.FieldByName('BAIRRO').AsString;
          Toma.EnderToma.cMun    := StrToInt(QParceiro.FieldByName('IBGE').AsString);
          Toma.EnderToma.xMun    := QParceiro.FieldByName('MUNICIPIO').AsString;
          Toma.EnderToma.UF      := QParceiro.FieldByName('ESTADO').AsString;;
          Toma.EnderToma.CEP     := StrToInt(Semmascara(QParceiro.FieldByName('CEP').AsString));
          Toma.EnderToma.cPais   := QParceiro.FieldByName('COD_PAIS').AsInteger;
          EXCEPT
          ...
          Toma.EnderToma.xPais := QDetalhe.FieldByName('DESCRICAO').AsString;

          if (Insc_Dest <> 'ISENTO') Then
          Toma.IE              := Insc_Dest;

          Toma.Email           := QParceiro.FieldByName('EMAIL').AsString;
        ...
        Exped.xNome              := NOME_EXPEDIDOR.TEXT;//
        Exped.CNPJCPF            := CNPJ_EXPEDIDOR.Text;//
        Exped.IE                 := INSCRICAO_EXPEDIDOR.TEXT;//
        Exped.enderExped.xLgr    := ENDERECO_EXPEDIDOR.TEXT;//
        Exped.enderExped.nro     := N_EXPEDIDOR.TEXT;//
        Exped.enderExped.xCpl    := ''; //
        Exped.enderExped.xBairro := BAIRRO_EXPEDIDOR.TEXT;//

        try
         Exped.enderExped.cMun := StrToInt(IBGE_EXPEDIDOR.Text);
        except
          Exped.enderExped.cMun := 0;
        end;
        //Rem.EnderReme.cMun    := StrToInt(QParceiro.FieldByName('IBGE').AsString);

        Exped.enderExped.xMun    := MUNICIPIO_EXPEDIDOR.Text;//

        try
          Exped.enderExped.CEP := StrToInt(SemMascara(CEP_EXPEDIDOR.Text));
        except
          Exped.enderExped.CEP := 0;
        end;
        //Rem.EnderReme.CEP     := StrToIntDef(QParceiro.FieldByName('CEP').AsString, 0);

        Exped.enderExped.UF      := UF_EXPEDIDOR.Text; //
        Exped.enderExped.cPais   := 1058;
        Exped.enderExped.xPais   := '1058';
        Exped.email              := email_expedidor.text;

        //Dados Recebedor

        Receb.xNome             := NOME_RECEBEDOR.TEXT;//
        Receb.CNPJCPF           := CNPJ_RECEBEDOR.Text;//
        Receb.IE                := INSCRICAO_RECEBEDOR.TEXT;//
        Receb.enderReceb.xLgr    := ENDERECO_RECEBEDOR.TEXT;//
        Receb.enderReceb.nro     := N_RECEBEDOR.TEXT;//
        Receb.enderReceb.xCpl    := ''; //
        Receb.enderReceb.xBairro := BAIRRO_RECEBEDOR.TEXT;//

        try
         Receb.enderReceb.cMun := StrToInt(IBGE_RECEBEDOR.Text);
        except
          Receb.enderReceb.cMun := 0;
        end;
        //Rem.EnderReme.cMun    := StrToInt(QParceiro.FieldByName('IBGE').AsString);

        Receb.enderReceb.xMun    := MUNICIPIO_RECEBEDOR.Text;//

        try
          Receb.enderReceb.CEP := StrToInt(SemMascara(CEP_RECEBEDOR.Text));
        except
          Receb.enderReceb.CEP := 0;
        end;
        //Rem.EnderReme.CEP     := StrToIntDef(QParceiro.FieldByName('CEP').AsString, 0);

        Receb.enderReceb.UF      := UF_RECEBEDOR.Text; //
        Receb.enderReceb.cPais   := 1058;
        Receb.enderReceb.xPais   := '1058';
        Receb.email              := email_recebedor.text;
     ...
     //  Local de Entrega
       ...
       if NOME_RECEBEDOR.TEXT <> '' then
       Begin
       Dest.locEnt.CNPJCPF := CNPJ_RECEBEDOR.Text;//
       Dest.locEnt.xNome   := NOME_RECEBEDOR.TEXT;//
       Dest.locEnt.xLgr    := ENDERECO_RECEBEDOR.TEXT;//
       Dest.locEnt.nro     := N_RECEBEDOR.TEXT;//
       Dest.locEnt.xCpl    := '';
       Dest.locEnt.xBairro := BAIRRO_RECEBEDOR.TEXT;//
       Dest.locEnt.cMun    := StrToInt(IBGE_RECEBEDOR.Text);
       Dest.locEnt.xMun    := MUNICIPIO_RECEBEDOR.Text;//
       Dest.locEnt.UF      := UF_RECEBEDOR.Text; //
       End;


       IF  (FrmPrincipal.QEmpresa.FieldByName('ESTADO').AsString = 'PE')  THEN
       Begin
        infRespTec.CNPJ     := '05.835.195/0001-03';
        InfRespTec.xContato := 'CLENIO BARROS';
        infRespTec.email    := 'CLENIOBARROS@EFICAZAUTOMACAO.COM.BR';
        infRespTec.fone     := '3837411478';
        infRespTEc.idCSRT   := 0;
        infREspTec.hashCSRT := ''; //EncdDecd.Encodebase64(RetornaHashSHA1('sf'));
       end;
        ...
        begin
         ...
         begin
          CNPJCPF := CNPJ_EXPEDIDOR.Text;
          IE      := INSCRICAO_EXPEDIDOR.Text;
          XNOME   := NOME_EXPEDIDOR.Text;
          UF      := UF_EXPEDIDOR.Text;
          with idDocAnt.Add do
          begin
           idDocAntEle.Add.chCTe := sub_chave_cte.Text;
          end;
         end;
        end;

       if FINALIDADE_EMISSAO.Text = '4-CTE SUBSTITUTO' then
       infCTeNorm.infCteSub.chCte := cte_origem.text;
       ...
       Begin
        ...
        begin
         ...
         if FINALIDADE_EMISSAO.Text = '4-CTE SUBSTITUTO' then
         infCTeNorm.infCteSub.tomaICMS.refNFe := QNotas.FieldByName('CHAVE_NFE').AsString;
         //infCTeNorm.infCteSub.tomaICMS.refCte

        end
        else iF QNOTAS.FieldByName('MODELO').AsString = '00' then
        Begin
        with infCTeNorm.infDoc.infOutros.Add do
         begin
          ...
          vDocFisc := RoundTo(QNotas.FieldByName('VALOR').AsFloat, -2);
         end;
        ...
        bEGIN
         ...
         if FINALIDADE_EMISSAO.Text = '4-CTE SUBSTITUTO' then
         Begin
         infCTeNorm.infCteSub.tomaICMS.refNF.nro    := StrToInt(QNotas.FieldByName('NUM_DOC').AsString);
         infCTeNorm.infCteSub.tomaICMS.refNF.serie  := StrToInt(QNotas.FieldByName('SERIE').AsString);
         infCTeNorm.infCteSub.tomaICMS.refNF.modelo := QNotas.FieldByName('MODELO').AsString
         End;

        end;

        Vr_carga := Vr_carga +  RoundTo(QNotas.FieldByName('VALOR').AsFloat, -2);
      ...
      //      end;
       ...
       //  Informações da Carga
        ...
        Begin
         ...
         qCarga :=  PESO_Bruto.Value;

        End;

        if Peso_liquido.value > 0 Then
        Begin
         With infCTeNorm.infCarga.infQ.Add do
         Begin
        ...
        infCTeNorm.infCarga.vCarga   := Vr_Carga;
      ...
      // iNFORMAÇAO TRANSPORTADOR
       if QTransacao.FieldByName('MODELO').AsString = '67' then
       Begin
       infCTeNorm.rodoOS.TAF            := TAF.TEXT;
       infCTeNorm.rodoOS.NroRegEstadual := Registro_estadual.Text;
      ...
      // Informação do Serviço
       ...
       infCTeNorm.infServico.xDescServ := LOCAL_EMBARQUE.Text;
       infCTeNorm.infServico.qCarga    := PESO_LIQUIDO.value;
      ...
      //Informações do Seguro
        ...
        if not VisualizarCTe.Checked then //GeraXML then
        begin
          FrmPrincipal.ACBrCte1.Conhecimentos.Assinar;
          FrmPrincipal.ACBrCte1.Conhecimentos.Items[0].GravarXML;


          IQuery.Sql.Clear;
          IQuery.Sql.Add('UPDATE TRANSACOES SET  CHAVE_NFE = :CHAVE_NFE');
          IQuery.Sql.Add('WHERE');
          IQuery.Sql.Add('(TRANSACAO_ID = :TRANSACAO_ID)');


          IQuery.ParamByName('TRANSACAO_ID').AsInteger := ID;
          IQuery.ParamByName('CHAVE_NFE').AsString     := FrmPrincipal.ACBrCte1.Conhecimentos.Items[0].NumID;

          IQuery.Prepare;
          IQuery.ExecSql;

          IQuery.Sql.Clear;
          IQuery.Sql.Add('UPDATE COMPL_CTEFISCAL SET  ARQUIVO_XML = :ARQUIVO_XML');
          IQuery.Sql.Add('WHERE');
          IQuery.Sql.Add('(TRANSACAO_ID = :TRANSACAO_ID)');

          IQuery.ParamByName('TRANSACAO_ID').AsInteger := ID;
          IQuery.ParamByName('ARQUIVO_XML').AsByteStr  := FrmPrincipal.ACBrCte1.Conhecimentos.Items[0].XML;
          ...
          begin
           ...
           // IQuery.ParamByName('HISTORICO').AsString     := QTransacao.FieldByName('HISTORICO').AsString  + StrZero(NO_DOC_FISCAL.Text, 9, 0);
            ...
            IQuery.Sql.Clear;
            IQuery.Sql.Add('UPDATE COMPL_CTEFISCAL SET RECIBO = :RECIBO, PROTOCOLO = :PROTOCOLO, CHAVE_NFE = :CHAVE_NFE, ARQUIVO_XML = :ARQUIVO_XML');
            IQuery.Sql.Add('WHERE');
            IQuery.Sql.Add('(TRANSACAO_ID = :TRANSACAO_ID)');


            if (QTransacao.FieldByName('MODELO').AsString = '57') OR  (QTransacao.FieldByName('MODELO').AsString = '67')Then
            Begin
            ...
            Else
            Begin
            IQuery.ParamByName('RECIBO').AsString        := '000000';
            IQuery.ParamByName('PROTOCOLO').AsString     := FrmPrincipal.ACBrCTe1.Conhecimentos.Items[0].CTe.procCTe.nProt;
            IQuery.ParamByName('CHAVE_NFE').AsString     := FrmPrincipal.ACBrCTe1.Conhecimentos.Items[0].CTe.procCTe.chCTe;
            End;
           ...
           begin
            try
              ...
              begin
                ...
                FrmPrincipal.MemoResp.Lines.Add('Empresa: ' + FrmPrincipal.QEmpresa.FieldByName('RAZAO').AsString + ' CNPJ: ' + FrmPrincipal.QEmpresa.FieldByName('CNPJ').AsString);
                FrmPrincipal.MemoResp.Lines.Add('');
                FrmPrincipal.MemoResp.Lines.Add('Cliente: ' + QParceiro.FieldByName('NOME').AsString + ' CNPJ/CPF: ' + QParceiro.FieldByName('CNPJ').AsString);
                FrmPrincipal.MemoResp.Lines.Add('');
                ...
                FrmPrincipal.ACBrCTe1.Conhecimentos.Items[0].EnviarEmail(QParceiro.FieldByName('EMAIL').AsString , edtEmailAssunto ,
                                                         FrmPrincipal.MemoResp.Lines
                                                         , True  // Enviar PDF junto
                                                         ,nil //CC  Lista com emails que serÃ£o enviado cÃ³pias - TStrings
                                                         ,nil); // Lista de anexos - TStrings
            ...
            if QTransacao.FieldByName('MODELO').AsString = '57' Then
            Begin
            ...
            Else
            Begin
            ShowMessage('Nº do Protocolo: ' + FrmPrincipal.ACBrCTe1.Conhecimentos.Items[0].CTe.procCTe.nProt);
            ShowMessage('Nº do Recibo: Cte-Os Não possui recibo envio síncrono.');
            End;
...
procedure TFrmCTe.btnrecebedorClick(Sender: TObject);
var
forne:integer;
begin
Forne := GetConsulta('CLIENTES', 0, 0, 0);
  ...
  if not IQuery.IsEmpty then
  begin
    NOME_RECEBEDOR.Text      := IQuery.FieldByName('NOME').AsString;
    CNPJ_RECEBEDOR.Text      := SemMascara(IQuery.FieldByName('CNPJ').AsString);
    ENDERECO_RECEBEDOR.Text  := Copy(IQuery.FieldByName('ENDERECO').AsString,1,50);
    MUNICIPIO_RECEBEDOR.Text := IQuery.FieldByName('MUNICIPIO').AsString;
    N_RECEBEDOR.Text         := IQuery.FieldByName('NUMERO').AsString;
    BAIRRO_RECEBEDOR.Text    := IQuery.FieldByName('BAIRRO').AsString;
    UF_RECEBEDOR.Text        := IQuery.FieldByName('ESTADO').AsString;
    IBGE_RECEBEDOR.Text                    := IQuery.FieldByName('IBGE').AsString;
    CEP_RECEBEDOR.Text       := IQuery.FieldByName('CEP').AsString;


    if IQuery.FieldByName('INSCRICAO').AsString = '' then
    INSCRICAO_RECEBEDOR.Text := 'ISENTO'
    Else
    INSCRICAO_RECEBEDOR.Text := IQuery.FieldByName('INSCRICAO').AsString;

    Email_RECEBEDOR.Text     := IQuery.FieldByName('EMAIL').AsString;
  end;
end;
...
procedure TFrmCTe.Button2Click(Sender: TObject);
var
...
begin
       ...
       Relatorio_Cte.LoadFromFile(ExtractFilePath(ParamStr(0)) + 'Relatorio_Ordem_Coleta_Cte.fr3');

     //   Relatorio_Cte.InheritFromTemplate('UCte.fr3');

      texto_fastrep:= TfrxMemoView(Relatorio_Cte.FindComponent('numero'));
       if texto_fastrep <> nil then
        texto_fastrep.Text := 'Número: ';// + N_ordem.Text;

     texto_fastrep:= TfrxMemoView(Relatorio_Cte.FindComponent('serie'));
       if texto_fastrep <> nil then
        texto_fastrep.Text := 'Série: ';// + S_ordem.Text;

      texto_fastrep:= TfrxMemoView(Relatorio_Cte.FindComponent('quantidade1'));
       if texto_fastrep <> nil then
        texto_fastrep.Text := FormatFloat( '#,##0' , Quantidade_Volumes.Value);

      texto_fastrep:= TfrxMemoView(Relatorio_Cte.FindComponent('especie1'));
        if texto_fastrep <> nil then
        texto_fastrep.Text := Prod_principal.Text;

      texto_fastrep:= TfrxMemoView(Relatorio_Cte.FindComponent('Documento1'));

        if texto_fastrep <> nil then
        texto_fastrep.Text := StrZero(QNotas.FieldByName('NUM_DOC').AsString,5,0) +  ' - ' + DateToStr(QNotas.FieldByName('DT_EMISSAO').ASDateTime);

      texto_fastrep:= TfrxMemoView(Relatorio_Cte.FindComponent('local'));
        if texto_fastrep <> nil then
        texto_fastrep.Text := ''; //DataPorExtenso(FrmPrincipal.QEmpresa.FieldByName('MUNICIPIO').AsString,date);



 Relatorio_Cte.ShowReport();
end;

procedure TFrmCTe.Button3Click(Sender: TObject);
begin
FrmPrincipal.Salva_Relatorio_FastReport_Bd(UnitName, 'cte');
  //FrmPrincipal.ACBrCTe1.Conhecimentos.Assinar;
  //FrmPrincipal.ACBrCTe1.DACTE := FrmPrincipal.ACBrCTeDACTEFR1;
  //FrmPrincipal.ACBrCTe1.Conhecimentos.Imprimir;
end;
...
begin
 DetailSearch('');
  ...
  if Validacao and (QTransacao.FieldByName('MODELO').AsString = '57') then
  begin
    if NO_DOC_FISCAL.Value > 0 then
    Begin
    //  Edit;
...
begin
  ...
  if (Key = Vk_F7) and (Sender = CNPJ_TRANSPORTADOR) then
      btnFornecedorClick(SENDER) ;//   CNPJ_TRANSPORTADOR.Text := GetConsulta_CFOP(CFOP_COMPL.Text);

  if (Key = Vk_F7) and (Sender = CNPJ_EXPEDIDOR) then
      btnExpedidorClick(SENDER) ;//   CNPJ_TRANSPORTADOR.Text := GetConsulta_CFOP(CFOP_COMPL.Text);

  if (Key = Vk_F7) and (Sender = CNPJ_RECEBEDOR) then
      btnRecebedorClick(SENDER) ;//   CNPJ_TRANSPORTADOR.Text := GetConsulta_CFOP(CFOP_COMPL.Text);

  if (Key = Vk_F7) and (Sender = Ibge) then
      btnIbgeClick(SENDER) ;

  if (Key = Vk_F7) and (Sender = Ibge_Origem) then
      btnIbgeOrigemClick(SENDER) ;

  if (Key = Vk_F7) and (Sender = Ibge_Destino) then
      btnIbgeDestinoClick(SENDER) ;
...
begin
  ...
  begin
    ...
    try
      ...
      Ini.ReadBinaryStream('Informações Adicionais Cte', 'Texto', StreamMemo);
  ...
  Begin
   ...
   begin
    Temp := Components[I];
     ...
     if Temp is TEdit then
       TEdit(Temp).Enabled := False;

    if Temp is TComboBox then
       TComboBox(Temp).Enabled := False;

    if Temp is TCurrencyEdit then
       TCurrencyEdit(Temp).Enabled := False;

    if Temp is TRxCalcEdit then
      TRxCalcEdit(Temp).Enabled := False;

    if Temp is TDateEdit then
      TDateEdit(Temp).Enabled := False;

    if Temp is TtabSheet  then
      TtabSheet(Temp).Enabled := False;

    if Temp is TMaskEdit  then
      TMaskEdit(Temp).Enabled := False;
...
begin
  ...
  try
    ...
    begin
      if FrmPasswordDlg.Password.Text = '123' then
      begin
         GeraXML := True;
         btnGeraClick(Sender);
         GeraXML := False;
