...
begin
  ...
  //ShowMessage(LogEntry('', '', LowerCase(MD5.HashStringAsHex('AMO A DEUS E MINHA FAMILIA' + StrZero(IQuery1.FieldByName('QTD').AsString,2,0)  + StrZero(QTD_LICENCA.Text,3,0) + FrmPrincipal.QEmpresa.FieldByName('CNPJ').AsString))));
