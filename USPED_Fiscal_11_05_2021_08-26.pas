...
var
  ...
  Deb_ICMS, Cred_ICMS, Vr_ICMS_ST: Real;
            ...
            BAIRRO   := Alltrim(QRel.FieldByName('BAIRRO').AsString);
{
      ...
      QRel.Sql.Clear;
      QRel.Sql.Add('SELECT * FROM CLIENTES');
      QRel.Sql.Add('WHERE');
      QRel.Sql.Add('(SPED = 1)');
...

{
      ...
      QRel.Sql.Clear;
      QRel.Sql.Add('SELECT COMPL_NFISCAL.*,TRANSACOES.MODELO,TRANSACOES.DT_SPED,TRANSACOES.EMPRESA_ID,TRANSACOES.TPCTB ');
      ...
      QRel.Sql.Add('AND (COMPL_NFISCAL.INSTRUCOES LIKE :INSTRUCOES)');
      ...
      QRel.ParamByName('INSTRUCOES').AsByteStr  := 'Rf.Doc' + '%' ;
      ...
      begin
       ...
       begin                     // Tabela de Informação Complementar do Documento Fiscal
         if Copy(QRel.FieldByName('INSTRUCOES').AsString,1,6) = 'Rf.Doc' Then
         Begin
         COD_INF :=  StrZero(QRel.FieldByName('NO_DOC_FISCAL').AsString, 6, 0);
         TXT     :=  Copy(QRel.FieldByName('INSTRUCOES').AsString,1,150);
         End;
       end;
      QRel.Next;
      end;
      ...
      begin
        ...
        begin
          // Tabela de Informações do Lanc. Fiscal
           ...
           TXT     := QRel.FieldByName('OBSERVACAO').AsString;
...
begin
  ...
  begin
      ...
      begin
       ...
       begin
        ...
        begin
          ...
          begin
           ...
           Else
            ...
            VL_SEG        := 0;
            VL_BC_ICMS    := QRel.FieldByName('BASE_ICMS_NORMAL').AsFloat - Desc_base_icms;
            VL_ICMS       := QRel.FieldByName('VR_ICMS_NORMAL').AsFloat - Desc_vl_icms;
            ...
            VL_BC_ICMS_ST := 0;
            VL_ICMS_ST    := 0;
            VL_OUT_DA     := QRel.FieldByName('VR_ACRESCIMO').AsFloat + QRel.FieldByName('VR_ICMS_ST').AsFloat;
            ...
            (QRel.FieldByName('CONDUTA').AsString = '02') and ((QRel.FieldByName('DEPTO').AsString = '10') or (QRel.FieldByName('DEPTO').AsString = '07')) then
            Begin
            VL_MERC       := QRel.FieldByName('VALOR_PRODUTOS').AsFloat + QRel.FieldByName('VR_IPI').AsFloat + QRel.FieldByName('VR_ICMS_ST').AsFloat  ;
            VL_IPI        := 0;
            VL_BC_ICMS_ST := 0;
            VL_ICMS_ST    := 0;
            End;
                ...
                begin
                   ...
                   Begin
                       ...
                       Begin
                        ...
                        End;
                       End;
                       if (QRel.FieldByName('CONDUTA').AsString = '02') and (QRel.FieldByName('DEPTO').AsString = '10')
                       AND ((Q113.FieldByName('MODELO').AsString = '55') or (Q113.FieldByName('MODELO').AsString = '65'))  then
                       Begin
                        With RegistroC113New do
                        Begin
                         IND_OPER := tpSaidaPrestacao;
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                VL_DESC          := QItens.FieldByName('DESC_RODAPE').AsFloat;
                ...
                // A pedido de Regivaldo dia 23/12/15
                ...
                VL_ITEM          := QItens.FieldByName('VR_TOTAL').AsFloat;
                ...
                Begin
                  IF  (((QRel.FieldByName('CONDUTA').AsString = '02') and (QRel.FieldByName('DEPTO').AsString = '10')) or ((QRel.FieldByName('CONDUTA').AsString = '02') and (QRel.FieldByName('DEPTO').AsString = '07'))) then
                  Begin
                  Vl_ITEM         := QItens.FieldByName('VR_TOTAL').AsFloat + QItens.FieldByName('VR_IPI').AsFloat + RoundTo(QItens.FieldByName('VALOR_ICMS_ST').AsFloat, -2);
                  VL_IPI          := 0;
                  VL_BC_ICMS_ST   := 0;
                  VL_ICMS_ST      := 0;
                  End;
         ...
         IF (QRel.FieldByName('CONDUTA').AsString = '02') then
          ...
          QItens.Sql.Add('SELECT CST, CFOP ,ALIQUOTA_ICMS,SUM(VR_FRETE) VR_FRETE,SUM(BASE_CALC_ICMS) BASE_CALC_ICMS ,SUM(VALOR_ICMS) VALOR_ICMS, ' +
                         ...
                         'FROM ('+
                         'SELECT CST,  TRANSITENS.CFOP,   CASE WHEN(CST = :070 OR CST = :010) THEN 0 ELSE ALIQUOTA_ICMS END ALIQUOTA_ICMS, ' +
                         'VR_FRETE, CASE WHEN(CST = :070 OR CST = :010) THEN 0 ELSE BASE_CALC_ICMS END BASE_CALC_ICMS, ' +
                         'CASE WHEN(CST = :070 OR CST = :010) THEN 0 ELSE VALOR_ICMS END VALOR_ICMS, BASE_CALC_ST, ' +
            ...
            begin
              ...
              begin
                ...
                if ((QRel.FieldByName('CONDUTA').AsString = '01') and (QRel.FieldByName('DEPTO').AsString = '10')) or ((QRel.FieldByName('CONDUTA').AsString = '02') and (QRel.FieldByName('DEPTO').AsString = '07')) then
                  Cred_ICMS  := Cred_ICMS + QItens.FieldByName('VALOR_ICMS').AsFloat
                else
                  Deb_ICMS   := Deb_ICMS + QItens.FieldByName('VALOR_ICMS').AsFloat;
        ...
        Begin
          ...
          Begin
          Cod_obs   := Copy(QRel.FieldByName('NUM_DOC').AsString,4,6);
          Txt_Compl := QRel.FieldByName('OBSERVACAO').AsString;
          End;
   ...
   End;
    ...
    QRel.Sql.Add('WHERE');
    QRel.Sql.Add('(EMPRESAS.EMPRESA_ID = :EMPRESA_ID) AND (LICENCA_IF.GERAR_SPED = 1) ');
...
var
Tem_Dados1, Tem_Dados2, Doc_Cancelado: Boolean;
begin
  Tem_Dados1 := True;
  Tem_Dados2 := True;
  ...
  QRel.Sql.Clear;
  QRel.Sql.Add('SELECT TRANSACOES.*,COMPL_CTEFISCAL.CHAVE_NFE CHAVE_CTE FROM TRANSACOES');
      ...
      begin
        ...
        begin
          ...
          COD_MUN_ORIG := FrmPrincipal.QEmpresa.FieldByName('IBGE').AsString;
           ...
           COD_MUN_DEST := QSearch.FieldByName('IBGE').AsString
           Else
           COD_MUN_DEST := '0000000';
          ...
          COD_MUN_Dest := FrmPrincipal.QEmpresa.FieldByName('IBGE').AsString;
           ...
           if not QSearch.isEmpty Then
           COD_MUN_ORIG := QSearch.FieldByName('IBGE').AsString
           Else
           COD_MUN_ORIG := '0000000';
...
//          end;
{
          ...
          begin
            ...
            COD_MUN_ORIG   := '3106200';
            COD_MUN_DEST   := '3151206';
            VEIC_ID        := 'HAV0018';
      ...
      begin
        ...
        begin
          ...
          if Deb_ICMS > Cred_ICMS then
            VL_SLD_APURADO := (Deb_ICMS - Cred_ICMS)
          else
            VL_SLD_APURADO := 0;
          ...
          if Deb_ICMS > Cred_ICMS then
            VL_ICMS_RECOLHER := (Deb_ICMS - Cred_ICMS)
          else
            VL_ICMS_RECOLHER := 0;
          ...
          if Cred_ICMS > Deb_ICMS then
            VL_SLD_CREDOR_TRANSPORTAR := (Cred_ICMS - Deb_ICMS);
          ...
          DEB_ESP := 0;
{
      ...
      QDetalhe.Sql.Clear;
      QDetalhe.Sql.Add('SELECT FORNECEDORES.ESTADO, SUM(TRANSITENS.VALOR_ICMS_ST) VALOR_ICMS_ST');
      ...
      QDetalhe.Sql.Add('GROUP BY FORNECEDORES.ESTADO');
      QDetalhe.Sql.Add('ORDER BY FORNECEDORES.ESTADO');
      ...
      QDetalhe.ParamByName('CD_DEV_VDA').AsString   := '01';
      QDetalhe.ParamByName('DP_DEV_VDA').AsString   := '10';
      QDetalhe.ParamByName('CFOP1').AsString        := '1%';
      QDetalhe.ParamByName('CFOP2').AsString        := '2%';
      QDetalhe.ParamByName('MG').AsString           := 'MG';
      QDetalhe.ParamByName('GO').AsString           := 'GO';
      QDetalhe.ParamByName('SP').AsString           := 'SP';
      QDetalhe.ParamByName('PR').AsString           := 'PR';
      QDetalhe.ParamByName('SC').AsString           := 'SC';
      QDetalhe.ParamByName('RJ').AsString           := 'RJ';
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            VL_DEVOL_ST                := 0;
            VL_RESSARC_ST              := 0;
            VL_OUT_CRED_ST             := QDetalhe.FieldByName('VALOR_ICMS_ST').AsFloat;
            VL_AJ_CREDITOS_ST          := 0;
            VL_RETENCAO_ST             := Vr_ICMS_ST;
            VL_OUT_DEB_ST              := 0;
            VL_AJ_DEBITOS_ST           := 0;
            VL_SLD_DEV_ANT_ST          := Vr_ICMS_ST;
            VL_DEDUCOES_ST             := 0;
            VL_ICMS_RECOL_ST           := Vr_ICMS_ST;
            VL_SLD_CRED_ST_TRANSPORTAR := QDetalhe.FieldByName('VALOR_ICMS_ST').AsFloat;
            DEB_ESP_ST                 := 0;
{
      ...
      QDetalhe.Sql.Clear;
      QDetalhe.Sql.Add('SELECT TRANSITENS.CST_IPI, TRANSITENS.CFOP, (CASE WHEN SUM(TRANSITENS.VR_IPI) > 0 THEN SUM(TRANSITENS.VR_TOTAL + TRANSITENS.VALOR_ICMS_ST + TRANSITENS.VR_FRETE + TRANSITENS.VR_ACRESCIMO + TRANSITENS.VR_IPI - DESC_RODAPE) ELSE 0 END) BASE_CALC_IPI , ' +
...
begin
  ...
  QRel.Sql.Add('WHERE');
  QRel.Sql.Add('(EMPRESA_ID = :EMPRESA_ID)');
  QRel.Sql.Add('AND (TIPO_ITEM = :TIPO)');

  QRel.Sql.Add('ORDER BY PRODUTOS.PRODUTO_ID');

  QRel.ParamByName('EMPRESA_ID').AsInteger    := FrmData.QAcesso.FieldByName('EMPRESA_ID').AsInteger;
  QRel.ParamByName('TIPO').AsString           := '00 - MERCADORIA PARA REVENDA';
    ...
    begin
     ...
     Begin
      ...
      begin
        ...
        QItens.Sql.Add('AND (PRODUTOS.TIPO_ITEM = :TIPO)');
        ...
        QItens.ParamByName('TIPO').AsString           := '00 - MERCADORIA PARA REVENDA';
    ...
    begin
     ...
     begin
      ...
      DT_FIN :=  Dtmai.Date;
        ...
        QItens.Sql.Clear;
        QItens.Sql.Add('SELECT DISTINCT TRANSITENS.PRODUTO_ID, QUANTIDADE_C ');
        QItens.Sql.Add('FROM TRANSITENS');
        QItens.Sql.Add('INNER JOIN TRANSACOES ON TRANSITENS.BANCO_ID = TRANSACOES.TRANSACAO_ID');
        QItens.Sql.Add('INNER JOIN PRODUTOS ON TRANSITENS.PRODUTO_ID = PRODUTOS.PRODUTO_ID');
        QItens.Sql.Add('WHERE');
        QItens.Sql.Add('DT_SPED BETWEEN :DT_INICIAL AND :DT_FINAL');
        QItens.Sql.Add('AND (CONDUTA = :CONDUTA OR CONDUTA = :CONDUTA01 ) AND (DEPTO = :DEPTO)');
        QItens.Sql.Add('AND (TRANSACOES.EMPRESA_ID = :EMPRESA_ID) AND (PRODUTOS.QUANTIDADE_C > 0)');

        QItens.Sql.Add('ORDER BY TRANSITENS.PRODUTO_ID');

        QItens.ParamByName('EMPRESA_ID').AsInteger  := FrmData.QAcesso.FieldByName('EMPRESA_ID').AsInteger;
        QItens.ParamByName('CONDUTA').AsString      := '21';
        QItens.ParamByName('CONDUTA01').AsString    := '19';
        ...
        Begin
          ...
          Begin
            ...
            Begin
              ...
              begin
               DT_INI_OS    := QRel.FieldByName('DT_SPED').AsDateTime;
               DT_FIN_OS    := QRel.FieldByName('DT_SPED').AsDateTime;
               COD_DOC_OS   := QRel.FieldByName('NUM_DOC').AsString;
          ...
          End
          else IF QRel.FieldByName('CONDUTA').AsString = '19' then
          begin
            QItens.Sql.Clear;
            QItens.Sql.Add('SELECT TRANSITENS.TRANSACAO_ID,DT_SPED, NUM_DOC, PRODUTO_ID,TRANSITENS.QUANTIDADE');
            QItens.Sql.Add('FROM TRANSITENS');
           ...
           { QDetalhe.SQL.Clear;
            QDetalhe.SQL.Add('SELECT PRODUTO_ID,QUANTIDADE FROM TRANSITENS');
            QDetalhe.SQL.Add('WHERE TRANSACAO_ID = :TRANSACAO_ID');
            QDetalhe.ParamByName('TRANSACAO_ID').AsInteger := QRel.FieldByName('TRANSACAO_ID').AsInteger;
            QDetalhe.Prepare;
            QDetalhe.Open();
            ...
            QItens.Sql.Clear;
            QItens.Sql.Add('SELECT DT_SPED, NUM_DOC, PRODUTO_ID,TRANSITENS.QUANTIDADE');
            QItens.Sql.Add('FROM TRANSITENS');
            QItens.Sql.Add('INNER JOIN TRANSACOES ON TRANSITENS.BANCO_ID = TRANSACOES.TRANSACAO_ID');
            QItens.Sql.Add('WHERE');
            QItens.Sql.Add('(TRANSITENS.BANCO_ID = :TRANSACAO_ID)');
...
begin
  ...
  begin
   ...
   End;
    ...
    QRel.Sql.Add('SELECT FINALIZADORAS.CLIENTE_ID,  CLIENTES.NOME, 0CREDITO , VALOR DEBITO FROM TRANSACOES ');
    QRel.Sql.Add('INNER JOIN FINALIZADORAS ON FINALIZADORAS.FINALIZADORA_ID = TRANSACOES.FINALIZADORA_ID ');
    QRel.Sql.Add('INNER JOIN CLIENTES ON FINALIZADORAS.CLIENTE_ID = CLIENTES.CLIENTE_ID ');
    QRel.Sql.Add('WHERE FINALIZADORAS.DESCRICAO LIKE :CARTAO  AND ');
  ...
  try
   ...
   End;
    ...
    Begin
      ...
      QRel.Sql.Add('WHERE');
      QRel.Sql.Add('(POSICAO_PRODUTOS.DT_MOVIMENTO = :DT_MOVIMENTO)');
      QRel.Sql.Add('AND (POSICAO_PRODUTOS.QUANTIDADE_C > 0) AND (PRODUTOS.TIPO_ITEM = :TIPO_ITEM)');
...
begin
  ...
  begin
    ...
    Label9.Visible := True;
    Label9.Caption := 'Data Inventário Bloco K';
    QRel.Sql.Clear;
    QRel.Sql.Add('SELECT DISTINCT DT_MOVIMENTO');
    QRel.Sql.Add('FROM POSICAO_PRODUTOS');
    QRel.Sql.Add('ORDER BY DT_MOVIMENTO');
