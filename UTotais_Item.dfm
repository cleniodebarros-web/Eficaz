object FrmTotais_Item: TFrmTotais_Item
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Totais p/ Item Compra/Venda'
  ClientHeight = 139
  ClientWidth = 327
  Color = clBtnFace
  ...
  object Itens_Total: TQuickRep
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel3: TQRLabel
        ...
        Alignment = taCenter
        AlignToBand = True
        Caption = '*** ITENS POR TOTAL COMPRA/VENDA ***'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
