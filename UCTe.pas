...
begin
 ...
 if FINALIDADE_EMISSAO.Text = '4-CTE SUBISTITUTO' then
 Begin
 ...
 End;
  ...
  if (FINALIDADE_EMISSAO.Text <> '1-CTE NORMAL') and (FINALIDADE_EMISSAO.Text <> '2-CTE COMPLEMENTO') and (FINALIDADE_EMISSAO.Text <> '3-CTE ANULACÃO') and (FINALIDADE_EMISSAO.Text <> '4-CTE SUBISTITUTO')  then
  begin
...
//        Ide.tpAmb
        ...
        else if FINALIDADE_EMISSAO.Text = '4-CTE SUBISTITUTO' then
...
//
        ...
        if FINALIDADE_EMISSAO.Text = '2-CTE COMPLEMENTO' then
          infCteComp10.New.chCTe := QTransacao.FieldByName('CHAVE_NFE_REF').AsString;
    ...
    //  Informações Complementares do CTe
     ...
     //  Local de Entrega
      ...
      //Informações do Seguro
        ...
        //infCTeSupl.qrCodCTe := 'https://portalcte.fazenda.mg.gov.br/portalcte/sistema/qrcode.xhtml';
