...
begin
  ...
  if  Copy(QTabela.FieldByName('OBSERVACAO').AsString,1,107) <> ''  Then
 // Brgommo
  Begin
    memo_Obs.Lines.Add('Observação: ' + Copy(QTabela.FieldByName('OBSERVACAO').AsString,1,87));
    memo_Obs.Lines.Add(Copy(QTabela.FieldByName('OBSERVACAO').AsString,88,100));
    memo_Obs.Lines.Add(Copy(QTabela.FieldByName('OBSERVACAO').AsString,188,100));
    memo_Obs.Lines.Add(Copy(QTabela.FieldByName('OBSERVACAO').AsString,288,100));
    memo_Obs.Lines.Add(Copy(QTabela.FieldByName('OBSERVACAO').AsString,388,100));
  End;
...
begin
  ...
  begin
    ...
    If (FrmPrincipal.Config.FieldByName('AUDITORIA').AsString = 'True') and (valor.value > 0) Then
       GravarLog('ORÇAMETNO','EDITAR',DateToStr(date),TimeToStr(time),'Ordem_id ' , IntToStr(QTabela.FieldByName('ORDEM_ID').AsInteger),FloatToStr(Valor.Value) + ' Documento: ' + InttoStr(QTabela.FieldByName('ORDEM_ID').AsInteger)  ,FrmData.QAcesso.FieldByName('FUNCIONARIO_ID').AsInteger,QTabela.FieldByName('CLIENTE_ID').AsInteger);
