object FrmRelatorio_Compras: TFrmRelatorio_Compras
  Left = 0
  Top = 0
  ...
  object BTN_LASER: TSpeedButton
    Left = 216
    Top = 293
    Width = 60
    Height = 24
    Caption = 'Incluir'
    OnClick = BTN_LASERClick
  end
  ...
  object GRUPO_ID: TCurrencyEdit
    ...
    TabOrder = 4
    ZeroEmpty = False
    OnChange = GRUPO_IDChange
    OnExit = GRUPO_IDExit
    OnKeyDown = GRUPO_IDKeyDown
  end
  object FAMILIA_ID: TCurrencyEdit
    ...
    TabOrder = 5
    ZeroEmpty = False
    OnChange = FAMILIA_IDChange
    OnExit = FAMILIA_IDExit
    OnKeyDown = FAMILIA_IDKeyDown
  end
  ...
  object SubTipo: TCurrencyEdit
    ...
    TabOrder = 6
    ZeroEmpty = False
    OnChange = SubTipoChange
    OnExit = SubTipoExit
    OnKeyDown = SubTipoKeyDown
  end
  ...
  object Localizacao: TCurrencyEdit
    ...
    TabOrder = 7
    ZeroEmpty = False
    OnChange = LocalizacaoChange
    OnExit = LocalizacaoExit
    OnKeyDown = LocalizacaoKeyDown
  end
  ...
  object Fim: TQuickRep
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel3: TQRLabel
        ...
        Alignment = taCenter
        AlignToBand = True
        Caption = '*** RELAT'#211'RIO DE COMPRAS ***'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
  ...
  object Produto_id: TCurrencyEdit
    ...
    TabOrder = 19
    ZeroEmpty = False
    OnChange = Produto_idChange
    OnExit = TributacaoExit
    OnKeyDown = LocalizacaoKeyDown
  end
  object Rel_Compras_Analitico_prod: TQuickRep
    Left = 8
    Top = 619
    Width = 1123
    Height = 794
    ...
    object QRBand7: TQRBand
      ...
      object QRLabel23: TQRLabel
        ...
        Alignment = taCenter
        AlignToBand = True
        Caption = '*** RELAT'#211'RIO DE COMPRAS ANAL'#205'TICO ***'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
    ...
    object QRBand9: TQRBand
      ...
      object QRExpr5: TQRExpr
        ...
        Font.Style = []
        Color = clWhite
        Master = Rel_Compras_Analitico_prod
        ParentFont = False
        ResetAfterPrint = True
        Transparent = False
        Expression = 'Sum(VR_TOTAL)'
  ...
  object QCfop: TFDQuery
    ...
    SQL.Strings = (
      'SELECT * FROM CFOP '
        ...
        'where (substring(cod_cfop from 1 for 1) = '#39'1'#39') OR (substring(cod' +
        '_cfop from 1 for 1) = '#39'2'#39') '
      'ORDER BY COD_CFOP')
    Left = 192
    Top = 523
  end
  ...
  object Table_Produto: TFDMemTable
    Active = True
    ...
    Left = 368
    Top = 120
    object Table_ProdutoProduto_id: TIntegerField
      DisplayLabel = 'C'#243'digo'
      DisplayWidth = 10
      FieldName = 'Produto_id'
    end
    object Table_ProdutoDescricao: TStringField
  ...
  object data_produto: TDataSource
    DataSet = Table_Produto
    Left = 464
    Top = 152
  end
end
