object FrmRel_ProdutosRetidosPDV: TFrmRel_ProdutosRetidosPDV
  Left = 100
  Top = 56
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Rel.  Produtos Retidos Pedido de Venda'
  ClientHeight = 161
  ClientWidth = 326
  Color = clBtnFace
  ...
  object ProdutosRetidos: TQuickRep
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel3: TQRLabel
        ...
        Alignment = taCenter
        AlignToBand = True
        Caption = '*** Produtos Retidos por Pedido de Venda ***'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
  ...
  object Chk_Pedido: TCheckBox
    Left = 73
    Top = 86
    Width = 184
    Height = 17
    Caption = 'Ordenar por Pedido de Venda'
    TabOrder = 6
  end
