object FrmAgrupar_Contas_Receber: TFrmAgrupar_Contas_Receber
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Agrupar Contas a Receber(Sem Juros)'
  ClientHeight = 310
  ClientWidth = 679
  Color = clBtnFace
  ...
  object QContas: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT CLIENTES.NOME, CLIENTES.ENDERECO, CLIENTES.NUMERO, TRANSP' +
        'ARCELAS.*, TRANSACOES.HISTORICO, TRANSACOES.NUM_DOC, TRANSACOES.' +
        'CONTA_ID, TRANSACOES.VENDEDOR_ID, TRANSACOES.EMPRESA_ID, TRANSAC' +
        'OES.TPCTB, TRANSACOES.C_CUSTO_ID, TRANSACOES.CLIENTE_ID'
      'FROM CLIENTES'
      'INNER JOIN TRANSACOES'
      ...
      'AND (TRANSPARCELAS.VALOR > 0)'
      'AND (TRANSPARCELAS.BANCO_ID = 0)'
      'ORDER BY CLIENTES.NOME, TRANSPARCELAS.DT_VENCIMENTO')
    Left = 64
    Top = 101
  end
