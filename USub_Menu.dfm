object FrmSub_Menu: TFrmSub_Menu
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  Caption = 'Config. Sub-Menu'
  ClientHeight = 230
  ClientWidth = 376
  Color = clBtnFace
  ...
  object USql_Transest: TFDUpdateSQL
    InsertSQL.Strings = (
      'insert into CONFIG_SUBMENU'
      '  (STATUS)'
      'values'
      '  (:STATUS)')
    ModifySQL.Strings = (
      ''
      'update CONFIG_SUBMENU'
      'set'
      '  STATUS = :STATUS'
      'where'
      '  ID = :OLD_ID')
    DeleteSQL.Strings = (
      'delete from CONFIG_SUBMENU'
      'where'
      '  ID = :OLD_ID')
    FetchRowSQL.Strings = (
      'Select '
