...
begin
  ...
  versao_orcamento.Text  := FrmPrincipal.Config.FieldByName('VERSAO_ORCAMENTO').AsString;
  ...
  try
    ...
    begin
      try
        ...
        QArq.SQL.Add('GERAR_BLOCO1400 = :GERAR_BLOCO1400, CONSISTIR_GERENCIAL = :CONSISTIR_GERENCIAL, DIFERENCA_ICMS = :DIFERENCA_ICMS,TOTALIZADOR_G = :TOTALIZADOR_G');
