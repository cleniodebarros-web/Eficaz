object FrmRel_Fechamento_Caixa: TFrmRel_Fechamento_Caixa
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Relat'#243'rio Fechamento de Caixa'
  ClientHeight = 298
  ClientWidth = 377
  Color = clBtnFace
  ...
  object Chk_PorHora: TCheckBox
    Left = 73
    Top = 41
    Width = 113
    Height = 17
    Caption = 'Filtrar pelo hor'#225'rio'
    TabOrder = 2
    OnClick = Chk_PorHoraClick
  end
  object HoraInicial: TMaskEdit
    Left = 73
    Top = 64
    Width = 39
    Height = 21
    ...
    TabOrder = 3
    Text = '  :  '
    OnKeyPress = HoraInicialKeyPress
  end
  object HoraFinal: TMaskEdit
    Left = 197
    Top = 62
    Width = 43
    Height = 21
  ...
  object chk_recebimento: TCheckBox
    Left = 8
    Top = 168
    Width = 232
    Height = 17
  ...
  object chk_caixas_separados: TCheckBox
    Left = 84
    Top = 253
    Width = 107
    Height = 17
    Caption = 'Caixas separados'
    TabOrder = 13
  end
  ...
  object DataOperador: TDataSource
    DataSet = QOperador
    Left = 370
    Top = 264
  end
  ...
  object QSangriaSuprimentoSintetico: TFDQuery
    Connection = FrmData.DbF_Eficaz
    Left = 424
    Top = 280
  end
