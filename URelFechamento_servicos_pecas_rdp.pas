unit URelFechamento_servicos_pecas_rdp;
...
type
  TFrmRelFechamento_servicos_pecas_rdp = class(TForm)
    Dtmen: TDateEdit;
    btnRetorna: TBitBtn;
    btnExecuta: TBitBtn;
    Bevel1: TBevel;
...
var
  FrmRelFechamento_servicos_pecas_rdp: TFrmRelFechamento_servicos_pecas_rdp;
  linha,Linha2, Pagina, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11: Integer;
  total_serv, total_pecas, total_geral, soma_vr_pecas, total_desconto,Total_Faturado,Total_Normal : Real;
...
procedure TFrmRelFechamento_servicos_pecas_rdp.btnAtendenteClick(Sender: TObject);
begin
  try
...
procedure TFrmRelFechamento_servicos_pecas_rdp.btnCentro_CustoClick(Sender: TObject);
begin
  try
...
procedure TFrmRelFechamento_servicos_pecas_rdp.btnClienteClick(Sender: TObject);
begin
   try
...
procedure TFrmRelFechamento_servicos_pecas_rdp.btnExecutaClick(Sender: TObject);
begin
  // 255, 325
  QRel.Sql.Clear;
 ...
 {Else if Rel_Movimento.Checked then
  ...
  QAtendimento.ParamByName('STATUS').AsString       := 'FATURADO';
...
procedure TFrmRelFechamento_servicos_pecas_rdp.btnRetornaClick(Sender: TObject);
begin
  Close;
end;

procedure TFrmRelFechamento_servicos_pecas_rdp.btnTecnicoClick(Sender: TObject);
begin
  try
...
procedure TFrmRelFechamento_servicos_pecas_rdp.DtmenKeyDown(Sender: TObject;
...
procedure TFrmRelFechamento_servicos_pecas_rdp.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFrmRelFechamento_servicos_pecas_rdp.FormCloseQuery(Sender: TObject;
...
procedure TFrmRelFechamento_servicos_pecas_rdp.FormCreate(Sender: TObject);
begin
...
procedure TFrmRelFechamento_servicos_pecas_rdp.Num_OrdemExit(Sender: TObject);
begin
   if Num_Ordem.Value > 0 then
   begin
...
procedure TFrmRelFechamento_servicos_pecas_rdp.RDprint1NewPage(Sender: TObject;
  Pagina: Integer);
  begin
...
procedure TFrmRelFechamento_servicos_pecas_rdp.TecnicoKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
