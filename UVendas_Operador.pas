...
type
  TFrmVendas_Operador = class(TForm)
    Label1: TLabel;
    Dtmen: TDateEdit;
    Dtmai: TDateEdit;
    Label2: TLabel;
...
var
  FrmVendas_Operador: TFrmVendas_Operador;
...
procedure TFrmVendas_Operador.btnExecutaClick(Sender: TObject);
begin
// 125, 327
  ...
  Else
  QRel.Sql.Add('ON (TRANSACOES.OPERADOR) = (TRIM(LEADING ''0'' FROM OPERADORES.OPERADOR_ID))');
...
procedure TFrmVendas_Operador.btnRetornaClick(Sender: TObject);
begin
  Close;
end;

procedure TFrmVendas_Operador.DtmenEnter(Sender: TObject);
begin
  Keybd_Event(VK_LEFT, 0, 0, 0);
end;

procedure TFrmVendas_Operador.DtmenKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmVendas_Operador.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFrmVendas_Operador.FormCreate(Sender: TObject);
begin
  QRel.Sql.Clear;
...
procedure TFrmVendas_Operador.OperadorKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
