...
uses
  ...
  FireDAC.Stan.Async, FireDAC.DApt, FireDAC.Comp.DataSet, FireDAC.Comp.Client,EncdDecd, pcnConversao;

type
  TFrmNFe_Se = class(TForm)
    Label3: TLabel;
    Label4: TLabel;
    Label2: TLabel;
    Label33: TLabel;
...
var
  FrmNFe_Se: TFrmNFe_Se;
  ID,IDX: Integer;
  GeraXML: Boolean;
  Cod_CFOP: String;
  Transmitido:Integer;

  procedure NFe_Se(Transacao_Id,enviado: Integer; CFOP: String);
...
procedure TFrmNFe_Se.Set_Campos(Vazio: Boolean);
var
I: Integer;
Temp: TComponent;
begin
...
function TFrmNFe_Se.Validacao: Boolean;
begin
  Result := False;
...
procedure TFrmNFe_Se.DetailSearch(Tabela: String);
begin
...
function TFrmNFe_Se.Search_Campo(Txt: String): Integer;
begin
...
begin
  ...
  Application.CreateForm(TFrmNFe_se, FrmNFe_se);
  try
    FrmNFe_se.ShowModal;
  finally
    FrmNFe_se.Release;
...
procedure TFrmNFe_Se.ProdutoSearch(ID: Integer);
begin
  QProdutos.Sql.Clear;
...
procedure TFrmNFe_Se.RESP_FRETEClick(Sender: TObject);
...
procedure TFrmNFe_Se.btnFornecedorClick(Sender: TObject);
var
Forne: Integer;
begin
...
procedure TFrmNFe_Se.btnGeraClick(Sender: TObject);
var
...
//        Ide.tpAmb
       ...
       End;
        ...
        if (QTransacao.FieldByName('CHAVE_NFE_REF').AsString <> '') and (FINALIDADE_EMISSAO.Text = '1-NFE NORMAL') then
        With  Ide.NFref.Add do
        Begin
        refNFe    := QTransacao.FieldByName('CHAVE_NFE_REF').AsString;
        End;
...
// alteracao da linha anterior a pedido de comercial bras nao enviar pRedBc percentual e sim valor
             ...
             End;
              ...
              if ((Ide.idDest = doInterestadual) or (Ide.idDest = doExterior))   Then
              Begin
          ...
          begin
            try
              ...
              begin
                ...
                FrmPrincipal.MemoResp.Lines.Add('Empresa: ' + FrmPrincipal.QEmpresa.FieldByName('RAZAO').AsString + ' CNPJ: ' + QParceiro.FieldByName('CNPJ').AsString );
                FrmPrincipal.MemoResp.Lines.Add('');
...
procedure TFrmNFe_Se.CFOP_COMPLExit(Sender: TObject);
begin
  DetailSearch('CFOP');
end;

procedure TFrmNFe_Se.CNPJ_TRANSPORTADORKeyDown(Sender: TObject;
...
procedure TFrmNFe_Se.DT_SAIDAEnter(Sender: TObject);
begin
  Keybd_Event(VK_LEFT, 0, 0, 0);
end;

procedure TFrmNFe_Se.DT_SAIDAExit(Sender: TObject);
begin
...
procedure TFrmNFe_Se.DT_SAIDAKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmNFe_Se.FormCreate(Sender: TObject);
begin
  GeraXML := False;
  IDX := 1;
...
procedure TFrmNFe_Se.FormShow(Sender: TObject);
var
IniFile: String;
Ini: TIniFile;
StreamMemo: TMemoryStream;
...
procedure TFrmNFe_Se.GerarXMLClick(Sender: TObject);
begin
