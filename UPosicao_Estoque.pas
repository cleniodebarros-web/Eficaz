...
// 151, 325
  try
    ...
    begin
      ...
      begin
        if FrmData.QAcesso.FieldByName('TPCTB').AsString = '2' then
          IQuery.Sql.Add('SELECT POSICAO_PRODUTOS.PRODUTO_ID, POSICAO_PRODUTOS.CUSTO_COMPRA, POSICAO_PRODUTOS.VALOR_COMPRA, ' +
                         'POSICAO_PRODUTOS.CUSTOMEDIO, POSICAO_PRODUTOS.PRECO_VAREJO, POSICAO_PRODUTOS.PRECO_ATACADO, POSICAO_PRODUTOS.QUANTIDADE_C AS QUANTIDADE, PRODUTOS.DESCRICAO, PRODUTOS.UNIDADE_VENDA, PRODUTOS.COD_BARRA')
        else
          IQuery.Sql.Add('SELECT POSICAO_PRODUTOS.PRODUTO_ID, POSICAO_PRODUTOS.CUSTO_COMPRA, POSICAO_PRODUTOS.VALOR_COMPRA, ' +
                         'POSICAO_PRODUTOS.CUSTOMEDIO, POSICAO_PRODUTOS.PRECO_VAREJO, POSICAO_PRODUTOS.PRECO_ATACADO, POSICAO_PRODUTOS.QUANTIDADE_G AS QUANTIDADE, PRODUTOS.DESCRICAO, PRODUTOS.UNIDADE_VENDA, PRODUTOS.COD_BARRA');
      ...
      begin
        if FrmData.QAcesso.FieldByName('TPCTB').AsString = '2' then
          IQuery.Sql.Add('SELECT PRODUTO_ID, DESCRICAO, CUSTO_COMPRA, VALOR_COMPRA, CUSTOMEDIO, PRECO_VAREJO, PRECO_ATACADO, UNIDADE_VENDA, QUANTIDADE_C AS QUANTIDADE, COD_BARRA')
        else
          IQuery.Sql.Add('SELECT PRODUTO_ID, DESCRICAO, CUSTO_COMPRA, VALOR_COMPRA, CUSTOMEDIO, PRECO_VAREJO, PRECO_ATACADO, UNIDADE_VENDA, QUANTIDADE_G AS QUANTIDADE, COD_BARRA');
