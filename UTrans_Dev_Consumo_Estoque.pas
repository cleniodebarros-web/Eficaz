unit UTrans_Dev_Consumo_Estoque;
...
type
  TFrmTrans_Dev_Consumo_Estoque = class(TForm)
...
var
  FrmTrans_Dev_Consumo_Estoque: TFrmTrans_Dev_Consumo_Estoque;
  Operacao: String;
  ID: Integer;
...
procedure TFrmTrans_Dev_Consumo_Estoque.CONTAAUX_IDExit(Sender: TObject);
begin
  DetailSearch('Conta Consumo');
end;

procedure TFrmTrans_Dev_Consumo_Estoque.CONTA_IDExit(Sender: TObject);
begin
  DetailSearch('Conta');
end;

procedure TFrmTrans_Dev_Consumo_Estoque.C_CUSTO_IDExit(Sender: TObject);
begin
  DetailSearch('C. Custo');
end;

procedure TFrmTrans_Dev_Consumo_Estoque.BANCO_IDExit(Sender: TObject);
begin
DetailSearch('Banco');
end;

procedure TFrmTrans_Dev_Consumo_Estoque.Botoes_Disable;
begin
...
procedure TFrmTrans_Dev_Consumo_Estoque.Botoes_Editing;
begin
  btnPrior.Enabled        := False;
  btnNext.Enabled         := False;
  btnInsert.Enabled       := False;
...
procedure TFrmTrans_Dev_Consumo_Estoque.Botoes_Normal;
begin
...
procedure TFrmTrans_Dev_Consumo_Estoque.DetailSearch(Tabela: String);
begin
...
procedure TFrmTrans_Dev_Consumo_Estoque.DiasClick(Sender: TObject);
begin
  ...
  begin
    ...
    QTabela.ParamByName('CONDUTA').AsString        := '18';
...
procedure TFrmTrans_Dev_Consumo_Estoque.DT_TRANSEnter(Sender: TObject);
begin
  Keybd_Event(VK_LEFT, 0, 0, 0);
end;

procedure TFrmTrans_Dev_Consumo_Estoque.DT_TRANSKeyDown(Sender: TObject;
...
procedure TFrmTrans_Dev_Consumo_Estoque.Habilitar(Status: Boolean);
var
I: Integer;
Temp: TComponent;
begin
...
procedure TFrmTrans_Dev_Consumo_Estoque.Insert;
var
I: Integer;
Temp: TComponent;
Sql, Par: String;
...
procedure TFrmTrans_Dev_Consumo_Estoque.Edit;
var
I: Integer;
Temp: TComponent;
Sql: String;
...
procedure TFrmTrans_Dev_Consumo_Estoque.ProdutoSearch;
begin
  QProduto.Close;
...
procedure TFrmTrans_Dev_Consumo_Estoque.TributoSearch;
begin
  QTributo.Close;
...
procedure TFrmTrans_Dev_Consumo_Estoque.EMPRESA_IDExit(Sender: TObject);
begin
  DetailSearch('Empresa');
end;

procedure TFrmTrans_Dev_Consumo_Estoque.EMPRESA_IDKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
function TFrmTrans_Dev_Consumo_Estoque.Validacao: Boolean;
begin
  Result := False;
...
procedure TFrmTrans_Dev_Consumo_Estoque.ManutencaoShow(Sender: TObject);
begin
  Set_Campos(False);
  Botoes_Normal;
end;

procedure TFrmTrans_Dev_Consumo_Estoque.QSub_DetailBeforeDelete(DataSet: TDataSet);
begin
...
procedure TFrmTrans_Dev_Consumo_Estoque.QSub_DetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TFrmTrans_Dev_Consumo_Estoque.QSub_DetailBeforeInsert(DataSet: TDataSet);
begin
  if QTabela.FieldByName('DT_MOVIMENTO').AsDateTime < FrmPrincipal.Abertura.FieldByName('DT_MOVIMENTO').AsDateTime then
  begin
    Application.MessageBox('Movimento já encerrado', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmTrans_Dev_Consumo_Estoque.QSub_DetailBeforePost(DataSet: TDataSet);
begin
  ProdutoSearch;
  TributoSearch;
...
procedure TFrmTrans_Dev_Consumo_Estoque.QSub_DetailNewRecord(DataSet: TDataSet);
begin
...
procedure TFrmTrans_Dev_Consumo_Estoque.Set_Campos(Vazio: Boolean);
var
I: Integer;
Temp: TComponent;
begin
...
procedure TFrmTrans_Dev_Consumo_Estoque.BtnbancoClick(Sender: TObject);
begin
  try
...
procedure TFrmTrans_Dev_Consumo_Estoque.btnCentro_CustoClick(Sender: TObject);
begin
  try
...
procedure TFrmTrans_Dev_Consumo_Estoque.btnContaAuxClick(Sender: TObject);
begin
  try
...
procedure TFrmTrans_Dev_Consumo_Estoque.btnContaClick(Sender: TObject);
begin
  try
...
procedure TFrmTrans_Dev_Consumo_Estoque.btnDeleteClick(Sender: TObject);
begin
  if FrmData.QAcesso.FieldByName('EXCLUSAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para exclusão', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmTrans_Dev_Consumo_Estoque.btnDiscardClick(Sender: TObject);
begin
  Botoes_Normal;
  Set_Campos(False);
...
procedure TFrmTrans_Dev_Consumo_Estoque.btnEditClick(Sender: TObject);
begin
  if FrmData.QAcesso.FieldByName('ALTERACAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para alteração', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmTrans_Dev_Consumo_Estoque.btnEmpresaClick(Sender: TObject);
begin
  try
...
procedure TFrmTrans_Dev_Consumo_Estoque.btnInsertClick(Sender: TObject);
begin
...
procedure TFrmTrans_Dev_Consumo_Estoque.btnNextClick(Sender: TObject);
begin
  Botoes_Disable;
...
procedure TFrmTrans_Dev_Consumo_Estoque.btnPesquisaClick(Sender: TObject);
var
Condicao: String;
begin
...
procedure TFrmTrans_Dev_Consumo_Estoque.btnPriorClick(Sender: TObject);
begin
  Botoes_Disable;
...
procedure TFrmTrans_Dev_Consumo_Estoque.btnRetornaClick(Sender: TObject);
begin
  Close;
end;

procedure TFrmTrans_Dev_Consumo_Estoque.btnSaveClick(Sender: TObject);
begin
  DetailSearch('');
...
procedure TFrmTrans_Dev_Consumo_Estoque.DBGrid1DblClick(Sender: TObject);
begin
  Manutencao.Show;
end;

procedure TFrmTrans_Dev_Consumo_Estoque.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    Manutencao.Show;
end;

procedure TFrmTrans_Dev_Consumo_Estoque.DBGrid1TitleClick(Column: TColumn);
begin
...
procedure TFrmTrans_Dev_Consumo_Estoque.ItensColEnter(Sender: TObject);
begin
...
procedure TFrmTrans_Dev_Consumo_Estoque.ItensColExit(Sender: TObject);
begin
  if QSub_Detail.State in [dsInsert, dsEdit] then
  begin
...
procedure TFrmTrans_Dev_Consumo_Estoque.ItensEnter(Sender: TObject);
begin
  Botoes_Disable;
  Consulta.TabVisible := False;
end;

procedure TFrmTrans_Dev_Consumo_Estoque.ItensExit(Sender: TObject);
begin
  if QSub_Detail.State in [dsInsert, dsEdit] then
  begin
    QSub_Detail.Cancel;
...
procedure TFrmTrans_Dev_Consumo_Estoque.ItensKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
...
procedure TFrmTrans_Dev_Consumo_Estoque.ItensKeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key = #46 then
    Key := #44;
...
procedure TFrmTrans_Dev_Consumo_Estoque.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFrmTrans_Dev_Consumo_Estoque.FormCloseQuery(Sender: TObject;
...
procedure TFrmTrans_Dev_Consumo_Estoque.FormCreate(Sender: TObject);
var
X, Ult_Dia: Integer;
begin
...
procedure TFrmTrans_Dev_Consumo_Estoque.FormShow(Sender: TObject);
begin
  DBGrid1.SetFocus;
end;
