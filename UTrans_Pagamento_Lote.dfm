object FrmTrans_Pagamento_Lote: TFrmTrans_Pagamento_Lote
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Trans. Mov. Financeira - Pagamento de Contas p/ Lote'
  ClientHeight = 394
  ClientWidth = 927
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Chk_ordenar: TCheckBox
      Left = 276
      Top = 8
      Width = 181
      Height = 17
      Caption = 'Ordenar por data de vencimento'
      TabOrder = 2
    end
  end
