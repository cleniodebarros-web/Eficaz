object FrmTotais_Item_Vendido_pedido: TFrmTotais_Item_Vendido_pedido
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Totais p/ Item Vendido no Pedido'
  ClientHeight = 153
  ClientWidth = 330
  Color = clBtnFace
  ...
  object Itens_Vendidos_Total: TQuickRep
    Left = 6
    Top = 238
    Width = 794
    Height = 1123
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel3: TQRLabel
        ...
        Alignment = taCenter
        AlignToBand = True
        Caption = '*** ITENS VENDIDOS - PEDIDO DE VENDA ***'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
  ...
  object Chk_Produtos_Faturados: TCheckBox
    Left = 73
    Top = 44
    Width = 194
    Height = 17
    Caption = 'Exibir somente produtos faturados'
    TabOrder = 6
    OnClick = Chk_Produtos_FaturadosClick
  end
