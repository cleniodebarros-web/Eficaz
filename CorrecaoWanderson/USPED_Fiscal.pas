      ...
      begin
        ...
        begin
                ...
                begin
                   ...
                   Begin
                      ...
                      if (QRel.FieldByName('CONDUTA').AsString = '01') and (QRel.FieldByName('DEPTO').AsString = '10') then
                       ...
                       AND (Q113.FieldByName('MODELO').AsString = '55') then
                       Begin
                        With RegistroC113New do
                        Begin
                         IND_OPER := tpSaidaPrestacao;
          ...
          begin
            ...
            QItens.First;
            while (not QItens.Eof) AND (NOT Doc_Cancelado) do
            begin
              ...
              begin
                ...
                Begin
                  ...
                  UNID             := Alltrim(QItens.FieldByName('UNIDADE').AsString);
                  end;
                End
                else
                begin
        ...
        if (Length(QRel.FieldByName('OBSERVACAO').AsString) > 3) and (not Doc_Cancelado) then
        Begin
...
//          end;
               ...
               if LeIni(Arq_Ini, 'Sintegra', 'Alterar CFOP Gás') =  'True' Then
                ...
                begin
                 ...
                 Begin
                  ...
                  (Alltrim(Q470.FieldByName('SIT_TRIBUTARIA').AsString) = 'N') OR (Alltrim(Q470.FieldByName('SIT_TRIBUTARIA').AsString) = 'F'))   Then
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  Q470.Sql.Clear;
                  Q470.Sql.Add('SELECT PRODUTOS.PRODUTO_ID, PRODUTOS.UNIDADE_VENDA, PRODUTOS.ALIQUOTA_ICMS, TRIBUTOS.ORIGEM, TRIBUTOS.TRIBUTACAO, TRIBUTOS.CFOP, SUM(REGISTRO_60I.QUANTIDADE) QUANTIDADE, SUM(REGISTRO_60I.QUANTIDADE * REGISTRO_60I.VR_UNITARIO) VR_TOTAL');
                  Q470.Sql.Add('FROM REGISTRO_60I');
          ...
          begin
            ...
            if (Q490.FieldByName('SIT_TRIBUTARIA').AsString = '0700') or (Q490.FieldByName('SIT_TRIBUTARIA').AsString = '1200') or (Q490.FieldByName('SIT_TRIBUTARIA').AsString = '0840') or
               ...
               (Q490.FieldByName('SIT_TRIBUTARIA').AsString = '1800') or (Q490.FieldByName('SIT_TRIBUTARIA').AsString = '2500') or (Q490.FieldByName('SIT_TRIBUTARIA').AsString = '3000') then
            begin
            ...
            if QTributo.FieldByName('ALIQUOTA_ICMS').AsFloat > 0 then
              Valor_ICMS := RoundTo(((Valor_Totalizador * QTributo.FieldByName('ALIQUOTA_ICMS').AsFloat) / 100), -2)
            else
              Valor_ICMS := 0;
