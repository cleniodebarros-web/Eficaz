  ...
  begin
    ...
    begin
       ...
       begin
         ...
         IQuery.SQL.Clear;
         IQuery.SQL.Add('SELECT PRODUTO_ID, DESCRICAO, UNIDADE FROM PRODUTOS WHERE COD_BARRA = :COD_BARRA');
         ...
         begin
             ...
             QSub_Detail.FieldByName('QUANTIDADE').AsFloat      := StrToFloat(XMLDOM.DocumentElement.ChildNodes[I].ChildNodes['QUANTIDADE'].Text);
             QSub_Detail.FieldByName('UNIDADE').AsString        := IQuery.FieldByName('UNIDADE').AsString;
             QSub_Detail.FieldByName('VR_UNITARIO').AsFloat     := StrToFloat(XMLDOM.DocumentElement.ChildNodes[I].ChildNodes['PRECO'].Text);
             QSub_Detail.FieldByName('VR_TOTAL').AsFloat        := StrToFloat(XMLDOM.DocumentElement.ChildNodes[I].ChildNodes['SUBTOTAL'].Text);
             QSub_Detail.Post;
         end
         else
