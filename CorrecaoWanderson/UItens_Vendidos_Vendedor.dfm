object FrmItens_Vendidos_Vendedor: TFrmItens_Vendidos_Vendedor
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Itens Vendido por Vendedor'
  ClientHeight = 141
  ClientWidth = 331
  Color = clBtnFace
  ...
  object Itens_Vendidos_Caixa: TQuickRep
    Left = 244
    Top = 212
    Width = 794
    Height = 1123
    ...
    PrintIfEmpty = True
    ReportTitle = 'Itens Vendidos p/ Caixa'
    SnapToGrid = True
    Units = MM
    Zoom = 100
    ...
    object ColumnHeaderBand1: TQRBand
      ...
      object QRLabel3: TQRLabel
        ...
        Alignment = taCenter
        AlignToBand = True
        Caption = '*** ITENS VENDIDOS POR CAIXA ***'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
    ...
    object QRBand1: TQRBand
      ...
      object QRExpr2: TQRExpr
        ...
        ResetAfterPrint = True
        Transparent = False
        Expression = 'Sum(VR_TOTAL + VR_ACRESCIMO - VR_DESCONTO)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
