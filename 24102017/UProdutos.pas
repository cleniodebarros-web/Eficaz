...
InputString := InputBox('Atualizar CEST', 'Código CEST:', '');
  ...
  begin
    ...
    begin
      ...
      begin
        IQuery.Sql.Clear;
        IQuery.Sql.Add('UPDATE PRODUTOS SET CEST = :CEST');
        IQuery.Sql.Add('WHERE');
  ...
  begin
   ...
   Application.MessageBox('Favor inserir um número inteiro válido.', PChar(Msg_Title), mb_IconStop);
    ...
    begin
      ...
      begin
        IQuery.Sql.Clear;
        IQuery.Sql.Add('UPDATE PRODUTOS SET FAMILIA_ID = :FAMILIA_ID');
        IQuery.Sql.Add('WHERE');
        IQuery.Sql.Add('(PRODUTO_ID = :PRODUTO_ID)');
...
IQuery.Sql.Clear;
    ...
    try
      ...
      begin
        ...
        {if (FrmEtiquetas_Novos.Impressora.Text = 'Elgin BTP-L42') then
        Begin
          if ( FrmEtiquetas_Novos.Modelo.Text = '3 Colunas') Then
          Begin
            D1  := '';
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  m_hPort := m_BPLBOcx.BPLBOpenPrinterDriver('BTP-L42(U)');
