...
begin
  ...
  csto_compra   := QSearch.FieldByName('CUSTO_COMPRA').AsFloat + Dif_Icms.Value;
...
Codigo_Valido: Boolean;
begin
  if (Key = Vk_F2) and (FrmPrincipal.Config.FieldByName('ESTOQUE_FILIAIS').AsString  = 'True') tHEN
  Begin

    Estoque_Filiais(QTabela.FieldByName('PRODUTO_ID_MATRIZ').AsInteger,QTabela.FieldByName('DESCRICAO').AsString);
  End;
...
procedure TFrmProdutos.FormMouseEnter(Sender: TObject);
begin
