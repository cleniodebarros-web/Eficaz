object FrmRel_Reducao_z: TFrmRel_Reducao_z
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Relat'#243'rio Redu'#231#227'o Z'
  ClientHeight = 175
  ClientWidth = 325
  Color = clBtnFace
  ...
  object Dt_movimento: TDateEdit
    ...
    NumGlyphs = 2
    TabOrder = 0
    OnEnter = Dt_movimentoEnter
    OnKeyDown = Dt_movimentoKeyDown
  end
  ...
  object DataImpressora: TDataSource
    DataSet = QImpressora
    Left = 96
    Top = 144
  end
