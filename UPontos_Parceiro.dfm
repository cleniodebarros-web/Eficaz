object FrmPontos_Parceiro: TFrmPontos_Parceiro
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Pontos Parceiros'
  ClientHeight = 136
  ClientWidth = 342
  Color = clBtnFace
  ...
  object Rel_Vendas_Vendedor: TQuickRep
    ...
    object DetailBand1: TQRBand
      ...
      object QRExpr16: TQRExpr
        ...
        Transparent = False
        Expression = '(CREDITO_PARCEIRO - DEBITO_PARCEIRO)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
    ...
    object QRBand1: TQRBand
      ...
      object QRExpr21: TQRExpr
        ...
        Transparent = False
        Expression = 'SUM(CREDITO_PARCEIRO)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr22: TQRExpr
        ...
        ResetAfterPrint = False
        Transparent = False
        Expression = 'SUM(DEBITO_PARCEIRO)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
      ...
      object QRExpr3: TQRExpr
        ...
        ResetAfterPrint = True
        Transparent = False
        Expression = 'Sum(CREDITO_PARCEIRO) - SUM(DEBITO_PARCEIRO)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
    ...
    object QRBand3: TQRBand
      ...
      object QRExpr7: TQRExpr
        ...
        ResetAfterPrint = True
        Transparent = False
        Expression = 'Sum(CREDITO_PARCEIRO - DEBITO_PARCEIRO)'
        Mask = '#,##0.00'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 8
  ...
  object Rel_Vendas_Sintetico: TQuickRep
    Left = 508
    Top = 59
    Width = 794
    Height = 1123
    ...
    object QRGroup3: TQRGroup
      ...
      KeepOnOnePage = False
      Expression = 'NOME'
      FooterBand = GrupoFuncionarioRodape
      Master = Rel_Vendas_Sintetico
      ReprintOnNewPage = False
    ...
    object GrupoFuncionarioRodape: TQRBand
      Left = 38
      Top = 168
      Width = 718
      Height = 34
