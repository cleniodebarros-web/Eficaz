...
type
  TFrmXml_Contabilidade_CTE = class(TForm)
    Label1: TLabel;
    Dtmen: TDateEdit;
    Dtmai: TDateEdit;
    Bevel1: TBevel;
...
var
  FrmXml_Contabilidade_CTE: TFrmXml_Contabilidade_CTE;
  ZipFile: TZipFile;
  dir,dest_dir:string;
...
procedure TFrmXml_Contabilidade_CTE.Procura;
...
procedure TFrmXml_Contabilidade_CTE.btnExecutaClick(Sender: TObject);
begin
...
procedure TFrmXml_Contabilidade_CTE.btnRetornaClick(Sender: TObject);
begin
  Close;
end;

procedure TFrmXml_Contabilidade_CTE.DtmenEnter(Sender: TObject);
begin
  Keybd_Event(VK_LEFT, 0, 0, 0);
end;

procedure TFrmXml_Contabilidade_CTE.DtmenKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmXml_Contabilidade_CTE.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFrmXml_Contabilidade_CTE.FormCreate(Sender: TObject);
begin
