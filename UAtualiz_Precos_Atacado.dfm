object FrmAtualiz_Precos_Atacado: TFrmAtualiz_Precos_Atacado
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Atualiza'#231#227'o de Pre'#231'os Atacado'
  ClientHeight = 443
  ClientWidth = 1024
  Color = clBtnFace
  ...
  object QProdutos: TFDQuery
    ...
    SQL.Strings = (
      'select FORNECEDORES.NOME FORNECEDOR,  PRODUTOS.*'
      'from produtos'
      
        'left join fornecedores on fornecedores.fornecedor_id = produtos.' +
        'fornecedor_id '
      '      ')
    Left = 24
    Top = 304
