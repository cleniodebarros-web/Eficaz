...
uses
  ...
  ACBrPosPrinter, sMaskEdit, sCustomComboEdit, sCurrEdit;


type

  TFrmOrcamento_4 = class(TForm)
    ...
    QRLabel83: TQRLabel;
    Label12: TLabel;
    valor_custo: TRxCalcEdit;
    Label14: TLabel;
    valor_repasse: TRxCalcEdit;
...
var
  FrmOrcamento_4: TFrmOrcamento_4;
  Operacao: String;
...
uses
  UPrincipal, UData, UConsulta, UParcelas, UPesquisa,UGerente,UAcesso, UCalc_Orcamento;

{$R *.dfm}

procedure TFrmOrcamento_4.ServicoSearch;
begin
  QServico.Close;
...
procedure TFrmOrcamento_4.OrcamentoBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
...
procedure TFrmOrcamento_4.Orcamento_ReduzidoBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
...
procedure  TFrmOrcamento_4.Ordenar(Valores: tStrings);
var i, j : integer;
    temp : string;
begin
...
procedure TFrmOrcamento_4.CLIENTE_IDExit(Sender: TObject);
begin
  DetailSearch('Cliente');
end;

procedure TFrmOrcamento_4.ConsultaShow(Sender: TObject);
begin
  Botoes_Normal;
end;

procedure TFrmOrcamento_4.Botoes_Disable;
begin
...
procedure TFrmOrcamento_4.Botoes_Editing;
begin
  btnPrior.Enabled     := False;
  btnNext.Enabled      := False;
  btnInsert.Enabled    := False;
...
procedure TFrmOrcamento_4.Botoes_Normal;
begin
...
procedure TFrmOrcamento_4.DetailSearch(Tabela: String);
begin
...
procedure TFrmOrcamento_4.DiasClick(Sender: TObject);
begin
...
procedure TFrmOrcamento_4.DT_ORCAMENTOEnter(Sender: TObject);
begin
  Keybd_Event(VK_LEFT, 0, 0, 0);
end;

procedure TFrmOrcamento_4.DT_ORCAMENTOKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TFrmOrcamento_4.Habilitar(Status: Boolean);
var
I: Integer;
Temp: TComponent;
begin
  ...
  begin
   ...
   if not (Temp is TsCalcEdit)  Then
   Begin
...
procedure TFrmOrcamento_4.Insert;
var
I: Integer;
Temp: TComponent;
Sql, Par: String;
...
procedure TFrmOrcamento_4.Edit;
var
I: Integer;
Temp: TComponent;
Sql: String;
...
procedure TFrmOrcamento_4.ProdutoSearch;
begin
  QProduto.Close;
...
procedure TFrmOrcamento_4.TributoSearch;
begin
  QTributo.Close;
...
procedure TFrmOrcamento_4.EMPRESA_IDExit(Sender: TObject);
begin
  DetailSearch('Empresa');
end;

procedure TFrmOrcamento_4.EMPRESA_IDKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
function TFrmOrcamento_4.Validacao: Boolean;
begin
  Result := False;
...
procedure TFrmOrcamento_4.VENDEDOR_IDExit(Sender: TObject);
begin
  DetailSearch('Vendedor');
end;

procedure TFrmOrcamento_4.VR_DESCONTOExit(Sender: TObject);
begin
{if FrmPrincipal.Config.FieldByName('DESC_ORC_USU').AsString = 'True' then
Begin
Desc_por := 0;
...
procedure TFrmOrcamento_4.ManutencaoShow(Sender: TObject);
begin
  QTabela.Refresh;
  Set_Campos(False);
  Botoes_Normal;
...
procedure TFrmOrcamento_4.OBSERVACAOEnter(Sender: TObject);
begin
Observacao.Text := Observacao.Text + ' ';
end;

procedure TFrmOrcamento_4.QSub_DetailAfterOpen(DataSet: TDataSet);
begin
...
TFloatField(QSub_Detail.FieldByName('VR_CUSTO')).DisplayFormat    := '#,##0.00';
TFloatField(QSub_Detail.FieldByName('VR_TOTAL_CUSTO')).DisplayFormat    := '#,##0.00';
TFloatField(QSub_Detail.FieldByName('VR_REPASSE')).DisplayFormat        := '#,##0.00';
TFloatField(QSub_Detail.FieldByName('VR_TOTAL_REPASSE')).DisplayFormat  := '#,##0.00';

end;

procedure TFrmOrcamento_4.QSub_DetailBeforeDelete(DataSet: TDataSet);
begin
...
procedure TFrmOrcamento_4.QSub_DetailBeforeEdit(DataSet: TDataSet);
begin
...
procedure TFrmOrcamento_4.QSub_DetailBeforeInsert(DataSet: TDataSet);
begin
  if (FrmPrincipal.Config.FieldByName('OBJETO_ORDEM').AsString <> 'Madereira') and (QTabela.FieldByName('DT_MOVIMENTO').AsDateTime < FrmPrincipal.Abertura.FieldByName('DT_MOVIMENTO').AsDateTime) then
  begin
    Application.MessageBox('Movimento já encerrado', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmOrcamento_4.QSub_DetailBeforePost(DataSet: TDataSet);
var
Cst: String;
Promocao: Boolean;
itemtemp:integer;
...
procedure TFrmOrcamento_4.QSub_DetailNewRecord(DataSet: TDataSet);
begin
  DataSet['ORCAMENTO_ID'] := QTabela.FieldByName('ORCAMENTO_ID').AsInteger;
  DataSet['TP_PROD_SERV'] := 'P';
end;

procedure TFrmOrcamento_4.QTabelaAfterOpen(DataSet: TDataSet);
begin
TFloatField(QTabela.FieldByName('VALOR')).DisplayFormat  := '#,##0.00';
end;

procedure TFrmOrcamento_4.RDprint1BeforeNewPage(Sender: TObject; Pagina: Integer);
begin
  if linha <= 62  then
  Begin
  RDprint1.Imp(63, 01, '================================================================================');
...
procedure TFrmOrcamento_4.RDprint1NewPage(Sender: TObject; Pagina: Integer);
begin
...
procedure TFrmOrcamento_4.RDprint2BeforeNewPage(Sender: TObject; Pagina: Integer);
begin
  if linha <= 62  then
  Begin
  RDprint1.Imp(63, 01, '==================================');
...
procedure TFrmOrcamento_4.Set_Campos(Vazio: Boolean);
var
I: Integer;
Temp: TComponent;
begin
...
procedure TFrmOrcamento_4.btnDeleteClick(Sender: TObject);
begin
  if FrmData.QAcesso.FieldByName('EXCLUSAO').AsString = 'NÃO' then
  begin
    Application.MessageBox('Usuário sem permissão para exclusão', PChar(Msg_Title), mb_IconStop);
...
procedure TFrmOrcamento_4.btnDiscardClick(Sender: TObject);
begin
  Botoes_Normal;
  Set_Campos(False);
...
procedure TFrmOrcamento_4.btnEditClick(Sender: TObject);
begin
...
procedure TFrmOrcamento_4.btnEmpresaClick(Sender: TObject);
begin
  try
...
procedure TFrmOrcamento_4.btnClienteClick(Sender: TObject);
begin
  try
...
procedure TFrmOrcamento_4.btnInsertClick(Sender: TObject);
begin
...
procedure TFrmOrcamento_4.btnLogClick(Sender: TObject);
var
F1: TextFile;
begin
   Set_Campos(False);
...
procedure TFrmOrcamento_4.btnNextClick(Sender: TObject);
begin
  if not QTabela.Eof then
  begin
    QTabela.Next;
...
procedure TFrmOrcamento_4.btnOrcamentoClick(Sender: TObject);
var
...
begin
  ...
  if (linha >= 66) or (linha2 >= 66) or (linha3 >= 66)   then
  Begin
  RDprint1.Novapagina;
  Pagina := Pagina + 1;
  Linha3 := 30;
...
procedure TFrmOrcamento_4.btnParcelasClick(Sender: TObject);
begin
...
procedure TFrmOrcamento_4.btnPesquisaClick(Sender: TObject);
var
Condicao: String;
begin
...
procedure TFrmOrcamento_4.btnPriorClick(Sender: TObject);
begin
  if not QTabela.Bof then
  begin
    QTabela.Prior;
...
procedure TFrmOrcamento_4.btnRetornaClick(Sender: TObject);
begin
  Close;
end;

procedure TFrmOrcamento_4.btnSaveClick(Sender: TObject);
begin
  DetailSearch('');
...
procedure TFrmOrcamento_4.btnVendedorClick(Sender: TObject);
begin
  try
...
procedure TFrmOrcamento_4.btnVendedor_2Click(Sender: TObject);
begin
try
...
procedure TFrmOrcamento_4.DBGrid1DblClick(Sender: TObject);
begin
  Manutencao.Show;
end;

procedure TFrmOrcamento_4.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure TFrmOrcamento_4.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
    Manutencao.Show;
end;

procedure TFrmOrcamento_4.DBGrid1TitleClick(Column: TColumn);
begin
...
procedure TFrmOrcamento_4.ItensColEnter(Sender: TObject);
begin
...
procedure TFrmOrcamento_4.ItensColExit(Sender: TObject);
begin
  if QSub_Detail.State in [dsInsert, dsEdit] then
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          QSub_Detail.FieldByName('VR_CUSTO').AsFloat      := 0;
    ...
    begin
      ...
      begin
        ...
        if (QProduto.FieldbyName('UNIDADE_VENDA').AsString = 'M2') then
        Begin

         QSub_Detail.FieldByName('QUANTIDADE').AsFloat := CalculaOrcamento(QTabela.FieldByName('ORCAMENTO_ID').AsInteger,QSub_Detail.FieldByName('PRODUTO_ID').AsInteger ,QProduto.FieldByName('DESCRICAO').AsString);
    ...
    QSub_Detail.FieldByName('VR_TOTAL_CUSTO').AsFloat   := QSub_Detail.FieldByName('QUANTIDADE').AsFloat * QSub_Detail.FieldByName('VR_CUSTO').AsFloat;
    QSub_Detail.FieldByName('VR_TOTAL_REPASSE').AsFloat := QSub_Detail.FieldByName('QUANTIDADE').AsFloat * QSub_Detail.FieldByName('VR_REPASSE').AsFloat;

  end;

end;

procedure TFrmOrcamento_4.ItensEnter(Sender: TObject);
begin
  Botoes_Disable;
  Consulta.TabVisible := False;
end;

procedure TFrmOrcamento_4.ItensExit(Sender: TObject);
begin
  if QSub_Detail.State in [dsInsert, dsEdit] then
  begin
    QSub_Detail.Cancel;
  ...
  VALOR_CUSTO.Value    := 0;
  VALOR_REPASSE.Value  := 0;

  QSub_Detail.First;
  while not QSub_Detail.Eof do
  begin
    VALOR_PRODUTOS.Value := VALOR_PRODUTOS.Value + QSub_Detail.FieldByName('VR_TOTAL').AsFloat;
    VALOR_CUSTO.Value    := VALOR_CUSTO.Value + QSub_Detail.FieldByName('VR_TOTAL_CUSTO').AsFloat;
    VALOR_REPASSE.Value  := VALOR_REPASSE.Value + QSub_Detail.FieldByName('VR_TOTAL_REPASSE').AsFloat;
...
procedure TFrmOrcamento_4.ItensKeyDown(Sender: TObject;
...
procedure TFrmOrcamento_4.ItensKeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key = #46 then
    Key := #44;
...
procedure TFrmOrcamento_4.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFrmOrcamento_4.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
...
procedure TFrmOrcamento_4.FormCreate(Sender: TObject);
var
X, Ult_Dia: Integer;
begin
  ...
  Itens.Columns[5].Width  := 55;
  Itens.Columns[6].Width  := 55;
  Itens.Columns[7].Width  := 60;
  Itens.Columns[9].Width  := 55;
  Itens.Columns[9].Width  := 80;
  Itens.Columns[10].Width := 80;
...
procedure TFrmOrcamento_4.FormShow(Sender: TObject);
begin
  DBGrid1.SetFocus;
end;
