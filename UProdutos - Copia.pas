...
begin
  ...
  if ((Tabela = '') or (Tabela = '') or (Tabela = 'Unidade Venda')) and (Unidade_Venda.Text <> '') then
  begin
...
procedure TFrmProdutos.TabSheet17Show(Sender: TObject);
begin
...
if QDesagregacao.State in [dsInsert, dsEdit] then
  begin
    ...
    Begin
      ...
      IF (IQuery.FieldByName('QUANTIDADE').AsFloat) + (QDesagregacao.FieldByname('QUANTIDADE').AsFloat) >= 150 Then
      Begin
