...
begin
  ...
  begin
    ...
    IQuery.SQL.Clear;
    IQuery.SQL.Add('UPDATE produtos set valor_compra = vr_unitario, custo_compra = vr_unitario, customedio = vr_unitario from');
    IQuery.SQL.Add('(select produto_id, vr_unitario from transitens where transacao_id = :TRANSACAO_ID) as CUSTO');
    IQuery.SQL.Add('where produtos.produto_id = custo.produto_id');
    IQuery.ParamByName('TRANSACAO_ID').AsInteger  := QTabela.FieldByName('TRANSACAO_ID').AsInteger;
    IQuery.Prepare;
    IQuery.ExecSql;
